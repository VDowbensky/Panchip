/********************************************************* * 
@file		:dma_4092byte_tfr.c 
@brief  	:spi dma test case, transfer 4092 byte form memory to peripheral spi with normal dma channel config
@author 	:zhongfeng
@version	:v1.0 
@date 		:19/08/29
...
uint32_t DMA_4092ByteTranferCase27(void)
{
    ...
    TxConfigTmp.AddrChangeSrc   = DMAC_AddrChange_NoChange;
    ...
    while(TestCntValue--){
        ...
        DMAC_StartChannel(DMA, gTxChNum,&SendData,(void*)&(SPI0->DR),1023);
