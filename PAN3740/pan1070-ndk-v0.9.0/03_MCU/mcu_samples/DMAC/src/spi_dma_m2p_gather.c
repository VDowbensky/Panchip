/********************************************************* * 
@file		:spi_dma_p2m.c 
@brief  	:spi dma test case,dma transfer form peripheral spi to memory with normal dma channel config
@author 	:zhongfeng
@version	:v1.0 
@date 		:19/08/29
...
uint32_t SPI_DmaMem2PeripheralTranferCase12(void)
{
    ...
    TxConfigTmp.GatherEnSrc     = ENABLE;
    ...
    while(TestCntValue--){
        ...
        DMA->CH[gTxChNum].SGR_L = ((0x1<<20)|(0x1<<0));
