/********************************************************* * 
@file		:dma_priority.c 
@brief  	:dma channel transfer form memory to peripheral spi with normal dma channel config,dma priority test
@author 	:zhongfeng
@version	:v1.0 
@date 		:19/08/29
...
uint32_t DMA_PriorityTranferCase23(void)
{
    ...
    TxConfigTmp2.ChannelPriority = DMAC_ChannelPriority_5;
	...
	if(__MaxDmaCh >= 3){
	    ...
	    TxConfigTmp2.ChannelPriority = DMAC_ChannelPriority_6;
