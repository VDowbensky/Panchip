...
void PWM_PrintSampleInfo()
{
    SYS_TEST("\n");
    SYS_TEST("+--------------------------------------------------------------------------------------+ \n");
    SYS_TEST("|                      PAN107X PWM Sample Code.                                        | \n");
    SYS_TEST("+--------------------------------------------------------------------------------------+ \n");
    SYS_TEST("|    Press key to start specific testcase:                                             | \n");
    SYS_TEST("|                                                                                      | \n");
    SYS_TEST("|    Input '0'    Testcase 0: Register Default Value Check.                            | \n");
    SYS_TEST("|    Input '1'    Testcase 1: PWM Counting Modes.                                      | \n");
    SYS_TEST("|    Input '2'    Testcase 2: PWM Counting Types and Interrupts.                       | \n");
    SYS_TEST("|    Input '3'    Testcase 3: PWM Operating Modes.                                     | \n");
    SYS_TEST("|    Input '4'    Testcase 4: Polarity Control.                                        | \n");
    SYS_TEST("|    Input '5'    Testcase 5: Trigger ADC Conversion.                                  | \n");
    SYS_TEST("+--------------------------------------------------------------------------------------+ \n");
}
...
void PWM_ClkSrcSel(void)
{
    ...
    case 'A':
    case 'a':
        CLK->APB1_CLK_CTRL &= ~(CLK_APB1CLK_PWM01_CLK_SEL_Msk | CLK_APB1CLK_PWM23_CLK_SEL_Msk | CLK_APB1CLK_PWM45_CLK_SEL_Msk | CLK_APB1CLK_PWM67_CLK_SEL_Msk);
        break;
    case 'B':
    case 'b':
        ...
        case 'b':
            ...
            while ((CLK->XTL_CTRL_3V & CLK_XTLCTL_STABLE_Msk) != CLK_XTLCTL_STABLE_Msk);
            CLK->CLK_TOP_CTRL_3V |= CLK_TOPCTL_32K_CLK_SEL_Msk_3v;
            break;
        default:
            break;
    ...
    while( c )
    {
        ...
        switch(c)
        {
            ...
            case '0':
                ...
                break;
            /* 1. PWM Counting Modes */
            case '1':
                PWM_TestFunctionEnter(1);
                break;
            /* 2. PWM Counting Types and Interrupts */
            case '2':
                PWM_TestFunctionEnter(2);
                break;
            /* 3. PWM Operating Modes */
            case '3':
                PWM_TestFunctionEnter(3);
                break;
            /* 4. Polarity Control */
            case '4':
                PWM_TestFunctionEnter(4);
                break;
            /* 5. Trigger ADC Conversion */
            case '5':
                PWM_TestFunctionEnter(5);
                break;
            default:
