/********************************************************* * 
@file		:i2c_slave_10bit_receive.c 
@brief  	:10bit i2c address slave receive data from 10bit i2c address master
@author 	:zhongfeng
@version	:v1.0 
@date 		:19/10/16
...
static void I2C_SysInit(I2C_T * I2Cx,uint8_t DmaEn,uint8_t u8Adr10BitEn)
{
    ...
    I2C_SetRxTirggerLevel(I2Cx, I2C_RX_TL_4);
...
{ 
    ...
    I2C_SysInit(I2C0,DMA_DISABLE,ADR10BIT_ENABLE);
