...
bool is_silicon_lab_test_mode(void)
{
    return (test_mode == SILICON_LAB_TEST_MODE);
}
...
void update_test_result_ui(void)
{
    ...
    sprintk(test_str,"last rssi:%d    ",last_rssi);
...
void update_settings_ui(void)
{
    ...
    if(test_mode == XN297_TEST_MODE || test_mode == SILICON_LAB_TEST_MODE || test_mode == B250K_TEST_MODE)
    {
        if(test_mode == XN297_TEST_MODE)
        {
            LcdDrawEnglish6x12Str(5,1,"297 RX SIDE    ",TFT_COLOR_BLUE,TFT_COLOR_WHITE);
        }

        if(test_mode == SILICON_LAB_TEST_MODE)
        {
            LcdDrawEnglish6x12Str(5,1,"Silicon RX SIDE  ",TFT_COLOR_BLUE,TFT_COLOR_WHITE);
        }

        if(test_mode == B250K_TEST_MODE)
        {
            LcdDrawEnglish6x12Str(5,1,"B250K RX SIDE    ",TFT_COLOR_BLUE,TFT_COLOR_WHITE);
        }
        ...
        LcdDrawEnglish6x12Str(5,1,"Normal RX     ",TFT_COLOR_BLUE,TFT_COLOR_WHITE);
        ...
        {
            case 1:
                sprintk(lcd_str,"Dev 1M 250K");
                break;
            case 2:
                sprintk(lcd_str,"Dev 1M 170K ");
                break;
            case 3:
