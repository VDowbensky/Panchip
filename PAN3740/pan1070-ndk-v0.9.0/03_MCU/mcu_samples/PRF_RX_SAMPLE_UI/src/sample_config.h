...
// <h> Board Select
// <o> board version select   <0=> EVB_2023_11_11    <1=> EVB_2023_12_22
#define CONFIG_BOARD_VERSION                   0
// <i> board version select

#define CONFIG_USE_PRF_ISR_CB
#define CONFIG_PRF_TRNS_TIME_XN297_MODE  1
