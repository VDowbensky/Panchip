...
typedef enum IRQn
{
    ...
    WWDT_IRQn                   = 7,      /*!< Windowed Watchdog Timer Interrupt */
    ...
    GPIO3_IRQn                  = 18,     /*!< GPIO Port 3 Interrupt */
    USBDMA_IRQn                 = 21,     /*!< USB DMA Interrupt */
    USB_IRQn                    = 22,     /*!< USB Interrupt */
    TRIM_IRQn                   = 23,     /*!< Clock Trim Interrupt */
...
#define TIMER_CMP_CMPDAT_Msk               (0xFFfffffful << TIMER_CMP_CMPDAT_Pos)              /*!< TIMER_T::CMP: CMPDAT Mask                   */
...
#define TIMER_INTSTS_TWKF0_Pos             (1)                                               /*!< TIMER_T::INTSTS: TWKF Position              */
#define TIMER_INTSTS_TWKF0_Msk             (0x1ul << TIMER_INTSTS_TWKF0_Pos)                  /*!< TIMER_T::INTSTS: TWKF Mask                  */

#define TIMER_INTSTS_TWKF1_Pos             (2)                                               /*!< TIMER_T::INTSTS: TWKF Position              */
#define TIMER_INTSTS_TWKF1_Msk             (0x1ul << TIMER_INTSTS_TWKF1_Pos)                  /*!< TIMER_T::INTSTS: TWKF Mask                  */

#define TIMER_INTSTS_TWKF2_Pos             (3)                                               /*!< TIMER_T::INTSTS: TWKF Position              */
#define TIMER_INTSTS_TWKF2_Msk             (0x1ul << TIMER_INTSTS_TWKF2_Pos)                  /*!< TIMER_T::INTSTS: TWKF Mask                  */

#define TIMER_INTSTS_TF0_Pos               (4)                                               /*!< TIMER_T::INTSTS: TF Position              */
#define TIMER_INTSTS_TF0_Msk               (0x1ul << TIMER_INTSTS_TF0_Pos)                  	 /*!< TIMER_T::INTSTS: TF Mask  								*/

#define TIMER_INTSTS_TF1_Pos               (5)                                               /*!< TIMER_T::INTSTS: TF Position              */
#define TIMER_INTSTS_TF1_Msk               (0x1ul << TIMER_INTSTS_TF1_Pos)                  	 /*!< TIMER_T::INTSTS: TF Mask  								*/

#define TIMER_INTSTS_TF2_Pos               (6)                                               /*!< TIMER_T::INTSTS: TF Position              */
#define TIMER_INTSTS_TF2_Msk               (0x1ul << TIMER_INTSTS_TF2_Pos)                  	 /*!< TIMER_T::INTSTS: TF Mask  								*/

#define TIMER_CNT_CNT_Pos                  (0)                                               /*!< TIMER_T::CNT: CNT Position                  */
#define TIMER_CNT_CNT_Msk                  (0xFFfffffful << TIMER_CNT_CNT_Pos)                 /*!< TIMER_T::CNT: CNT Mask                      */

#define TIMER_CAP_CAPDAT_Pos               (0)                                               /*!< TIMER_T::CAP: CAPDAT Position               */
#define TIMER_CAP_CAPDAT_Msk               (0xFFfffffful << TIMER_CAP_CAPDAT_Pos)              /*!< TIMER_T::CAP: CAPDAT Mask                   */
...
#define TRIM_COARSE_CODE_Msk                            (0xful << TRIM_COARSE_CODE_Pos)
#define TRIM_FINE_CODE_Pos                              (8)           
#define TRIM_FINE_CODE_Msk                              (0xfful << TRIM_FINE_CODE_Pos)
#define TRIM_BIT_WIDTH_Pos                              (16)           
...
#define TRIM_CLRL_EARLY_TERM_EN_Pos                     (1)           
#define TRIM_CLRL_EARLY_TERM_EN_Msk                     (0x1ul << TRIM_CLRL_EARLY_TERM_EN_Pos)
#define TRIM_CLRL_FAIL_CLAC_FLAG_Pos                    (2)           
#define TRIM_CLRL_FAIL_CLAC_FLAG_Msk                    (0x1ul << TRIM_CLRL_FAIL_CLAC_FLAG_Pos)
#define TRIM_CLRL_CODE_STEP_Pos                         (8)           
#define TRIM_CLRL_CODE_STEP_Msk                         (0xfful << TRIM_CLRL_CODE_STEP_Pos)
...
typedef struct {
    ...
    */
    ...
    __IO  uint32_t CTL2;		/*OFFSET:0X58*/
    __I  uint32_t RESERVED2[4];	/*OFFSET:0X60*/
...
#define ADC_DAT_RESULT_Msk               (0xfffful << ADC_DAT_RESULT_Pos)                   /*!< ADC_T::DAT: RESULT Mask                   */
...
#define ADC_CTL_FIFO_EN_Pos              (9)                                               /*!< ADC_T::CTL: fifo enable Position              */
#define ADC_CTL_FIFO_EN_Msk              (0x1ul << ADC_CTL_FIFO_EN_Pos)                    /*!< ADC_T::CTL: fifo enable Mask                  */
#define ADC_CTL_FIFO_THRE_STATE_Pos      (10)                                              /*!< ADC_T::CTL: fifo half or full state Position  */
#define ADC_CTL_FIFO_THRE_STATE_Msk      (0x1ul << ADC_CTL_FIFO_THRE_STATE_Pos)            /*!< ADC_T::CTL: fifo half or full state Mask      */
...
#define ADC_CTL_SWTRG_Pos                (11)                                              /*!< ADC_T::CTL: SWTRG Position                */
#define ADC_CTL_SWTRG_Msk                (0x1ul << ADC_CTL_SWTRG_Pos)                      /*!< ADC_T::CTL: SWTRG Mask                    */
#define ADC_CTL_LEFT_SHIFT_EN_Pos        (12)                                              /*!< ADC_T::CTL: left shift enable Position    */
#define ADC_CTL_LEFT_SHIFT_EN_Msk        (0x1ul << ADC_CTL_LEFT_SHIFT_EN_Pos)              /*!< ADC_T::CTL: left shift enabl Mask         */
#define ADC_CTL_SUB_BIAS_EN_Pos          (13)                                              /*!< ADC_T::CTL: sub bias enabl Position       */
#define ADC_CTL_SUB_BIAS_EN_Msk          (0x1ul << ADC_CTL_SUB_BIAS_EN_Pos)                /*!< ADC_T::CTL: sub bias Mask                 */
#define ADC_CTL_BIAS_VALUE_Pos           (16)                                              /*!< ADC_T::CTL: bias Position                 */
#define ADC_CTL_BIAS_VALUE_Msk           (0xffful << ADC_CTL_BIAS_VALUE_Pos)               /*!< ADC_T::CTL: bias Mask                     */
...
#define ADC_CHEN_CHEN8_VBG_Pos           (8)                                               /*!< ADC_T::CHEN: VBG 1.2V Position            */
#define ADC_CHEN_CHEN8_VBG_Msk           (0x1ul << ADC_CHEN_CHEN8_VBG_Pos)                 /*!< ADC_T::CHEN: VBG 1.2V Mask                */
#define ADC_CHEN_CH9_TMP_Pos             (9)                                               /*!< ADC_T::CHEN: TEMPERATURE2 Position        */
#define ADC_CHEN_CH9_TMP_Msk             (0x1ul << ADC_CHEN_CH9_TMP_Pos)                   /*!< ADC_T::CHEN: TEMPERATURE2 Mask            */
#define ADC_CHEN_CH10_VDD_4_Pos          (10)                                              /*!< ADC_T::CHEN: VDD/4 Position               */
#define ADC_CHEN_CH10_VDD_4_Msk          (0x1ul << ADC_CHEN_CH10_VDD_4_Pos)                /*!< ADC_T::CHEN: VDD/4 Mask                   */
#define ADC_CHEN_CH11_VBG_2_Pos          (11)                                              /*!< ADC_T::CHEN: VBG/2 Position               */
#define ADC_CHEN_CH11_VBG_2_Msk          (0x1ul << ADC_CHEN_CH11_VBG_2_Pos)                /*!< ADC_T::CHEN: VBG/2 Mask                   */
...
typedef struct {
    __IO uint32_t P0_MFP; //0x00
    __IO uint32_t P1_MFP; //0x04
    __IO uint32_t P2_MFP; //0x08
    __IO uint32_t P3_MFP; //0x0C
    __IO  uint32_t RESV[12]; 
    __O  uint32_t REGLCTL; //0x40
    __IO  uint32_t STATUS; //0x44
    __IO  uint32_t CTRL0;  //0x48
	__IO  uint32_t CTRL1;  //0x4C
} SYS_T;
...
typedef struct {
	...
	__IO uint32_t BODCTL_3V;            //0x4004000C
	__IO uint32_t BLDBCTL_3V;           //0x40040010
	__IO uint32_t CLK_TOP_CTRL_3V;      //0x40040014
	__IO uint32_t RCL_CTRL_3V;          //0x40040018
	__IO uint32_t RCH_CTRL;             //0x4004001C
	__IO uint32_t XTL_CTRL_3V;          //0x40040020
	__IO uint32_t XTH_CTRL;             //0x40040024  
	__IO uint32_t DPLL_CTRL;            //0x40040028
	__IO uint32_t AHB_CLK_CTRL;         //0x4004002C
	__IO uint32_t APB1_CLK_CTRL;        //0x40040030
	__IO uint32_t APB2_CLK_CTRL;        //0x40040034
	__IO uint32_t MEAS_CLK_CTRL;        //0x40040038
} CLK_T;
...
#define CLK_RSTSTS_PORRF_Pos             (6)                                           
#define CLK_RSTSTS_PORRF_Msk             (0x1ul << CLK_RSTSTS_PORRF_Pos)               
...
#define CLK_IPRST0_CHIPSCOPEEN_Pos       (9)                                           
#define CLK_IPRST0_CHIPSCOPEEN_Msk       (0x1ul << CLK_IPRST0_CHIPSCOPEEN_Pos)
#define CLK_IPRST0_FTORRST_Pos           (10)                                           
#define CLK_IPRST0_FTORRST_Msk           (0x1ul << CLK_IPRST0_FTORRST_Pos)
...
#define CLK_IPRST1_TRIMRST_Pos           (16)                                         
#define CLK_IPRST1_TRIMRST_Msk           (0x1ul << CLK_IPRST1_TRIMRST_Pos)            

/*BODCTL*/                                                                            
#define CLK_BODCTL_BODRSTEN_Pos_3v       (3)                                          
#define CLK_BODCTL_BODRSTEN_Msk_3v       (0x1ul << CLK_BODCTL_BODRSTEN_Pos_3v)           
...
#define CLK_BODCTL_LVREN_Pos_3v          (16)                                          
#define CLK_BODCTL_LVREN_Msk_3v          (0x1ul << CLK_BODCTL_LVREN_Pos_3v) 
#define CLK_BODCTL_BODEN_Pos_3v          (17)                                          
#define CLK_BODCTL_BODEN_Msk_3v          (0x1ul << CLK_BODCTL_BODEN_Pos_3v)   
#define CLK_BODCTL_BODSEL_Pos_3v         (18)                                          
#define CLK_BODCTL_BODSEL_Msk_3v         (0x7ul << CLK_BODCTL_BODSEL_Pos_3v)  
#define CLK_BODCTL_LVR_TEST_Pos_3v       (21)                                          
#define CLK_BODCTL_LVR_TEST_Msk_3v       (0x1ul << CLK_BODCTL_LVR_TEST_Pos_3v)  
#define CLK_BODCTL_BOD_TEST_Pos_3v       (22)                                          
#define CLK_BODCTL_BOD_TEST_Msk_3v       (0x1ul << CLK_BODCTL_BOD_TEST_Pos_3v)  

/*BOD LVR DEBOUCE CTL*/                                                               
#define CLK_BLDBCTL_LVRDB_SEL_Pos_3v     (8)                                          
#define CLK_BLDBCTL_LVRDB_SEL_Msk_3v     (0x3Ful << CLK_BLDBCTL_LVRDB_SEL_Pos_3v)        
#define CLK_BLDBCTL_BODDB_SEL_Pos_3v     (0)                                          
#define CLK_BLDBCTL_BODDB_SEL_Msk_3v     (0x3Ful << CLK_BLDBCTL_BODDB_SEL_Pos_3v)        
                                                                                      
/*CLK_TOP_CTRL_3V*/
#define CLK_TOPCTL_RSICV_SYSCNT_EN_Pos   (0)                                         
#define CLK_TOPCTL_RSICV_SYSCNT_EN_Msk   (0x1ul << CLK_TOPCTL_RSICV_SYSCNT_EN_Pos)            
#define CLK_TOPCTL_SYS_CLK_SEL_Pos       (8)                                         
#define CLK_TOPCTL_SYS_CLK_SEL_Msk       (0x3ul << CLK_TOPCTL_SYS_CLK_SEL_Pos)           
#define CLK_TOPCTL_32K_CLK_SEL_Pos_3v    (10)                                        
#define CLK_TOPCTL_32K_CLK_SEL_Msk_3v    (0x1ul << CLK_TOPCTL_32K_CLK_SEL_Pos_3v)
...
/*RCL_CTRL_3V*/                                                                         
#define CLK_RCLCTL_RC32K_EN_Pos_3v       (0)                                         
#define CLK_RCLCTL_RC32K_EN_Msk_3v       (0x1ul << CLK_RCLCTL_RC32K_EN_Pos_3v)           
#define CLK_RCLCTL_RC32K_TST_EN_Pos      (1)                                         
#define CLK_RCLCTL_RC32K_TST_EN_Msk      (0x1ul << CLK_RCLCTL_RC32K_TST_EN_Pos)           
#define CLK_RCLCTL_CLK_SEL_Pos_3v        (2)                                         
#define CLK_RCLCTL_CLK_SEL_Msk_3v        (0x1ul << CLK_RCLCTL_CLK_SEL_Pos_3v)           
#define CLK_RCLCTL_RC32K_COARSE_Pos_3v   (4)                                         
#define CLK_RCLCTL_RC32K_COARSE_Msk_3v   (0xFul << CLK_RCLCTL_RC32K_COARSE_Pos_3v)           
#define CLK_RCLCTL_RC32K_FINE_Pos_3v     (8)                                         
#define CLK_RCLCTL_RC32K_FINE_Msk_3v     (0xFFul << CLK_RCLCTL_RC32K_FINE_Pos_3v)           
#define CLK_RCLCTL_RC32K_DELAY_Pos_3v    (16)                                         
#define CLK_RCLCTL_RC32K_DELAY_Msk_3v    (0x3ul << CLK_RCLCTL_RC32K_DELAY_Pos_3v)           
#define CLK_RCLCTL_STABLE_Pos       	 (24)                                         
#define CLK_RCLCTL_STABLE_Msk       	 (0x1ul << CLK_RCLCTL_STABLE_Pos)           

/*RCH_CTRL*/                                                                         
#define CLK_RCHCTL_RCH_EN_Pos            (0)                                         
#define CLK_RCHCTL_RCH_EN_Msk            (0x1ul << CLK_RCHCTL_RCH_EN_Pos)           
#define CLK_RCHCTL_RCH_TST_EN_Pos        (1)                                         
#define CLK_RCHCTL_RCH_TST_EN_Msk        (0x1ul << CLK_RCHCTL_RCH_TST_EN_Pos)           
#define CLK_RCHCTL_CLK_SEL_Pos           (2)
#define CLK_RCHCTL_CLK_SEL_Msk           (0x1ul << CLK_RCHCTL_CLK_SEL_Pos)
#define CLK_RCHCTL_BIAS_Pos              (4)
#define CLK_RCHCTL_BIAS_Msk              (0x3ul << CLK_RCHCTL_BIAS_Pos)
#define CLK_RCHCTL_RCH_FREQ_Pos          (8)
#define CLK_RCHCTL_RCH_FREQ_Msk          (0xFFul << CLK_RCHCTL_RCH_FREQ_Pos)
#define CLK_RCHCTL_DELAY_Pos             (16)
#define CLK_RCHCTL_DELAY_Msk             (0x3ul << CLK_RCHCTL_DELAY_Pos)
#define CLK_RCHCTL_STABLE_Pos       	 (24)
#define CLK_RCHCTL_STABLE_Msk       	 (0x1ul << CLK_RCHCTL_STABLE_Pos)

/*XTL_CTRL_3V*/                                                                         
#define CLK_XTLCTL_XTL_EN_Pos_3v         (0)                                         
#define CLK_XTLCTL_XTL_EN_Msk_3v         (0x1ul << CLK_XTLCTL_XTL_EN_Pos_3v)           
#define CLK_XTLCTL_XTL_TST_EN_Pos        (1)                                         
#define CLK_XTLCTL_XTL_TST_EN_Msk        (0x1ul << CLK_XTLCTL_XTL_TST_EN_Pos)           
#define CLK_XTLCTL_CORE_BIAS_Pos_3v      (4)                                         
#define CLK_XTLCTL_CORE_BIAS_Msk_3v      (0x7ul << CLK_XTLCTL_CORE_BIAS_Pos_3v)           
#define CLK_XTLCTL_XTL_TRIM_Pos_3v       (7)                                         
#define CLK_XTLCTL_XTL_TRIM_Msk_3v       (0x3Ful << CLK_XTLCTL_XTL_TRIM_Pos_3v)           
#define CLK_XTLCTL_XTL_CAP_EN_Pos_3v     (13)                                         
#define CLK_XTLCTL_XTL_CAP_EN_Msk_3v     (0x1ul << CLK_XTLCTL_XTL_CAP_EN_Pos_3v)           
#define CLK_XTLCTL_DELAY_Pos_3v          (16)                                     
#define CLK_XTLCTL_DELAY_Msk_3v          (0x3ul << CLK_XTLCTL_DELAY_Pos_3v)           
#define CLK_XTLCTL_STABLE_Pos       	 (24)
#define CLK_XTLCTL_STABLE_Msk       	 (0x1ul << CLK_XTLCTL_STABLE_Pos)       

/* XTH_CTRL */                                                                         
#define CLK_XTHCTL_XTH_EN_Pos            (0)                                         
#define CLK_XTHCTL_XTH_EN_Msk            (0x1ul << CLK_XTHCTL_XTH_EN_Pos)           
#define CLK_XTHCTL_XTH_TST_EN_Pos        (1)                                         
#define CLK_XTHCTL_XTH_TST_EN_Msk        (0x1ul << CLK_XTHCTL_XTH_TST_EN_Pos)           
#define CLK_XTHCTL_START_FAST_Pos        (2)                                         
#define CLK_XTHCTL_START_FAST_Msk        (0x1ul << CLK_XTHCTL_START_FAST_Pos)                     
#define CLK_XTHCTL_DEGLITCH_EN_Pos       (3)                                         
#define CLK_XTHCTL_DEGLITCH_EN_Msk       (0x1ul << CLK_XTHCTL_DEGLITCH_EN_Pos)                     
#define CLK_XTHCTL_XO_CAP_SEL_Pos        (4)
#define CLK_XTHCTL_XO_CAP_SEL_Msk        (0x3ful << CLK_XTHCTL_XO_CAP_SEL_Pos)
#define CLK_XTHCTL_DELAY_Pos             (16)
#define CLK_XTHCTL_DELAY_Msk             (0x1ul << CLK_XTHCTL_DELAY_Pos)
#define CLK_XTHCTL_STABLE_Pos       	 (24)
#define CLK_XTHCTL_STABLE_Msk       	 (0x1ul << CLK_XTHCTL_STABLE_Pos)

/*DPLL CTL*/
#define CLK_DPLLCTL_DPLL_EN_Pos          (0)                                         
#define CLK_DPLLCTL_DPLL_EN_Msk          (0x1ul << CLK_DPLLCTL_DPLL_EN_Pos)           
#define CLK_DPLLCTL_DPLL_TST_EN_Pos      (1)                                         
#define CLK_DPLLCTL_DPLL_TST_EN_Msk      (0x1ul << CLK_DPLLCTL_DPLL_TST_EN_Pos)           
#define CLK_DPLLCTL_FREQ_OUT_Pos         (2)                                         
#define CLK_DPLLCTL_FREQ_OUT_Msk         (0x1ul << CLK_DPLLCTL_FREQ_OUT_Pos)
#define CLK_DPLLCTL_RCLK_SEL_Pos         (3)                                         
#define CLK_DPLLCTL_RCLK_SEL_Msk         (0x1ul << CLK_DPLLCTL_RCLK_SEL_Pos)
#define CLK_DPLLCTL_ICP_BIAS_Pos         (4)                                         
#define CLK_DPLLCTL_ICP_BIAS_Msk         (0x3ul << CLK_DPLLCTL_ICP_BIAS_Pos)
#define CLK_DPLLCTL_ICP_CTRL_Pos         (6)                                         
#define CLK_DPLLCTL_ICP_CTRL_Msk         (0x3ul << CLK_DPLLCTL_ICP_CTRL_Pos)
#define CLK_DPLLCTL_KVCO_CTRL_Pos        (8)                                         
#define CLK_DPLLCTL_KVCO_CTRL_Msk        (0x7ul << CLK_DPLLCTL_KVCO_CTRL_Pos)
#define CLK_DPLLCTL_VCO_FREQ_TRIM_Pos    (11)                                         
#define CLK_DPLLCTL_VCO_FREQ_TRIM_Msk    (0x3ul << CLK_DPLLCTL_VCO_FREQ_TRIM_Pos)
#define CLK_DPLLCTL_DIV_SEL_Pos          (13)                                         
#define CLK_DPLLCTL_DIV_SEL_Msk          (0x1ul << CLK_DPLLCTL_DIV_SEL_Pos)
#define CLK_DPLLCTL_DELAY_Pos            (16)                                         
#define CLK_DPLLCTL_DELAY_Msk            (0x3ul << CLK_DPLLCTL_STARTUP_Pos)           
#define CLK_DPLLCTL_STABLE_Pos       	 (24)
#define CLK_DPLLCTL_STABLE_Msk       	 (0x1ul << CLK_DPLLCTL_STABLE_Pos)
...
#define CLK_AHBCLK_BLE32M_SEL_Msk        (0x3ul << CLK_AHBCLK_BLE32M_SEL_Pos) 
#define CLK_AHBCLK_ROM_CLK_EN_Pos        (10)                                         
#define CLK_AHBCLK_ROM_CLK_EN_Msk        (0x1ul << CLK_AHBCLK_ROM_CLK_EN_Pos)
#define CLK_AHBCLK_EFUSE_CLK_EN_Pos      (11)                                         
#define CLK_AHBCLK_EFUSE_CLK_EN_Msk      (0x1ul << CLK_AHBCLK_EFUSE_CLK_EN_Pos)
#define CLK_AHBCLK_USB_AHB_CLK_EN_Pos    (13)                                         
#define CLK_AHBCLK_USB_AHB_CLK_EN_Msk    (0x1ul << CLK_AHBCLK_USB_AHB_CLK_EN_Pos)
#define CLK_AHBCLK_USB_48M_CLK_EN_Pos    (14)                                         
#define CLK_AHBCLK_USB_48M_CLK_EN_Msk    (0x1ul << CLK_AHBCLK_USB_48M_CLK_EN_Pos)
#define CLK_AHBCLK_SPI_FLASH_DIV_Pos     (16)                                         
#define CLK_AHBCLK_SPI_FLASH_DIV_Msk     (0xFul << CLK_AHBCLK_SPI_FLASH_DIV_Pos)      
#define CLK_AHBCLK_SPI_FLASH_CLK_SEL_Pos (20)                                         
#define CLK_AHBCLK_SPI_FLASH_CLK_SEL_Msk (0x1ul << CLK_AHBCLK_SPI_FLASH_CLK_SEL_Pos)      
#define CLK_AHBCLK_DPLL_CLK_TST_EN_Pos   (21)                                         
#define CLK_AHBCLK_DPLL_CLK_TST_EN_Msk   (0x1ul << CLK_AHBCLK_DPLL_CLK_TST_EN_Pos)      
#define CLK_AHBCLK_SPI_CLK_SEL_FPGA_Pos  (24)                                         
#define CLK_AHBCLK_SPI_CLK_SEL_FPGA_Msk  (0x1ul << CLK_AHBCLK_SPI_CLK_SEL_FPGA_Pos)      
...
#define CLK_APB1CLK_PWM01_CLK_SEL_Pos    (20)                                         
#define CLK_APB1CLK_PWM01_CLK_SEL_Msk    (0x1ul << CLK_APB1CLK_PWM01_CLK_SEL_Pos)           
#define CLK_APB1CLK_PWM23_CLK_SEL_Pos    (21)                                         
#define CLK_APB1CLK_PWM23_CLK_SEL_Msk    (0x1ul << CLK_APB1CLK_PWM23_CLK_SEL_Pos)           
#define CLK_APB1CLK_PWM45_CLK_SEL_Pos    (22)                                         
#define CLK_APB1CLK_PWM45_CLK_SEL_Msk    (0x1ul << CLK_APB1CLK_PWM45_CLK_SEL_Pos)           
#define CLK_APB1CLK_PWM67_CLK_SEL_Pos    (23)                                         
#define CLK_APB1CLK_PWM67_CLK_SEL_Msk    (0x1ul << CLK_APB1CLK_PWM67_CLK_SEL_Pos)           
#define CLK_APB1CLK_ADC_CLK_SEL_Pos      (24)                                         
#define CLK_APB1CLK_ADC_CLK_SEL_Msk      (0x1ul << CLK_APB1CLK_ADC_CLK_SEL_Pos)
...
/* MEAS_CLK_CTRL */
#define CLK_MEASCLK_TRIM_CLK_EN_Pos       (1)                                         
#define CLK_MEASCLK_TRIM_CLK_EN_Msk       (0x1ul << CLK_MEASCLK_TRIM_CLK_EN_Pos)   
#define CLK_MEASCLK_TRIM_CLK_SEL_Pos      (2)                                         
#define CLK_MEASCLK_TRIM_CLK_SEL_Msk      (0x1ul << CLK_MEASCLK_TRIM_CLK_SEL_Pos)           
#define CLK_MEASCLK_TRIM_CLK_DIV_Pos      (4)                                         
#define CLK_MEASCLK_TRIM_CLK_DIV_Msk      (0x1fful << CLK_MEASCLK_TRIM_CLK_DIV_Pos)           
#define CLK_MEASCLK_XTL_QUICK_EN_Pos      (14)                                         
#define CLK_MEASCLK_XTL_QUICK_EN_Msk      (0x1ul << CLK_MEASCLK_XTL_QUICK_EN_Pos)           
#define CLK_MEASCLK_XTH_DIV_Pos           (15)                                         
#define CLK_MEASCLK_XTH_DIV_Msk           (0x1fful << CLK_MEASCLK_XTH_DIV_Pos)           
...
typedef struct 
{
	...
	__IO uint32_t X_FL_IRQ_CTL;      //0X1c
	__IO uint32_t X_FL_SUS_RESU_CMD; //0X20
}FLCTL_T;
...
//X_FL_CONFIG
#define FLCTL_CONFIG_FLASH_CAP_Pos          (3)
#define FLCTL_CONFIG_FLASH_CAP_Msk          (0x7ul << FLCTL_CONFIG_FLASH_CAP_Pos)
...
//X_FL_X_MODE
#define FLCTL_X_MODE_TIMEOUT_CNT_Pos        (26)
#define FLCTL_X_MODE_TIMEOUT_CNT_Msk        (0x3Ful << FLCTL_X_MODE_TIMEOUT_CNT_Pos)
#define FLCTL_X_MODE_RESUME_EN_Pos          (25)
#define FLCTL_X_MODE_RESUME_EN_Msk          (0x1ul << FLCTL_X_MODE_RESUME_EN_Pos)
#define FLCTL_X_MODE_SUS_SUCCESS_Pos        (24)
#define FLCTL_X_MODE_SUS_SUCCESS_Msk        (0x1ul << FLCTL_X_MODE_SUS_SUCCESS_Pos)
...
//X_FL_DP_CTL
#define FLCTL_DP_CTL_RDP_WT_CNT_Pos         (16)
#define FLCTL_DP_CTL_RDP_WT_CNT_Msk         (0xFFFFul << FLCTL_DP_CTL_RDP_WT_CNT_Pos)
#define FLCTL_DP_CTL_DP_WT_CNT_Pos          (4)
#define FLCTL_DP_CTL_DP_WT_CNT_Msk          (0xFFFul << FLCTL_DP_CTL_DP_WT_CNT_Pos)
#define FLCTL_DP_CTL_DP_EN_Pos              (0)
#define FLCTL_DP_CTL_DP_EN_Msk              (0x1ul << FLCTL_DP_CTL_DP_EN_Pos)

//X_FL_SUS_RESU_CMD
#define FLCTL_PROGRAM_SUS_CMD_Pos           (24)
#define FLCTL_PROGRAM_SUS_CMD_Msk           (0xFFul << FLCTL_PROGRAM_SUS_CMD_Pos)
#define FLCTL_PROGRAM_RESUME_CMD_Pos        (16)
#define FLCTL_PROGRAM_RESUME_CMD_Msk        (0xFFul << FLCTL_PROGRAM_RESUME_CMD_Pos)
#define FLCTL_ERASE_SUS_CMD_Pos             (8)
#define FLCTL_ERASE_SUS_CMD_Msk             (0xFFul << FLCTL_ERASE_SUS_CMD_Pos)
#define FLCTL_ERASE_RESUME_CMD_Pos          (0)
#define FLCTL_ERASE_RESUME_CMD_Msk          (0xFFul << FLCTL_ERASE_RESUME_CMD_Pos)
...
//CTRL1
#define SPI_CR1_SPI_MODE_SEL_Pos          (10)
#define SPI_CR1_SPI_MODE_SEL_Msk          (0x1ul << SPI_CR1_SPI_MODE_SEL_Pos)
#define SPI_CR1_CMD_DAT_EN_Pos            (9)
#define SPI_CR1_CMD_DAT_EN_Msk            (0x1ul << SPI_CR1_CMD_DAT_EN_Pos)
#define SPI_CR1_CMD_DAT_CTRL_Pos          (8)
#define SPI_CR1_CMD_DAT_CTRL_Msk          (0x1ul << SPI_CR1_CMD_DAT_CTRL_Pos)
#define SPI_CR1_WR_CTRL_Pos               (7)
#define SPI_CR1_WR_CTRL_Msk               (0x1ul << SPI_CR1_WR_CTRL_Pos)
...
typedef struct{
		...
		__IO uint32_t LP_FL_CTRL_3V;			//(0x04)
		__IO uint32_t LP_SPACING_TIME0;			//(0x08)
		__IO uint32_t LP_SPACING_TIME1;			//(0x0C)
		__IO uint32_t LP_SPACING_TIME2;			//(0x10)
		__I  uint32_t LP_SLPTMR;				//(0x14)
        __IO uint32_t LP_INT_CTRL;				//(0x18)
		__IO uint32_t LP_DLY_CTRL_3V;			//(0x1C)
		__IO uint32_t LP_PTAT_POLY;				//(0x20)
		__IO uint32_t LP_HP_LDO;				//(0x24)
		__IO uint32_t LP_LP_LDO_3V;				//(0x28)
		__IO uint32_t LP_ANA_LDO;				//(0x2C)
		__IO uint32_t LP_FSYN_LDO;				//(0x30)
		__IO uint32_t LP_SW;					//(0x34)
		__IO uint32_t LP_BUCK_3V;				//(0x38)
		__IO uint32_t ANA_ADC_LDO;				//(0x3C)
		__IO uint32_t ANA_RFFE_LDO;				//(0x40)
		__IO uint32_t ANA_VCO_LDO;				//(0x44)
		__IO uint32_t ANA_DFT;					//(0x48)
		__IO uint32_t ANA_MISC_3V;				//(0x4C)
		__IO uint32_t ANA_RESERVED_3V;			//(0x50)
		__IO uint32_t ACT_32K_CTRL;				//(0x54)
		__IO uint32_t ACT_32K_BASECORR;			//(0x58)
		__IO uint32_t CPU_ADDR_REMAP_CTRL;		//(0x5C)
		__IO uint32_t RCL_HW_CAL_CTRL;			//(0x60)
}ANA_T;

/*LP_REG_SYNC*/
#define ANAC_LP_REG_SYNC_3V_Pos					(0)
#define ANAC_LP_REG_SYNC_3V_Msk					(0x1ul << ANAC_LP_REG_SYNC_3V_Pos)
#define ANAC_LP_REG_SYNC_3V_TRG_Pos				(1)
#define ANAC_LP_REG_SYNC_3V_TRG_Msk				(0x1ul << ANAC_LP_REG_SYNC_3V_TRG_Pos)
/*LP_FL_CTRL_3V*/
#define ANAC_FL_SLEEP_MODE_SEL_Pos				(0)
#define ANAC_FL_SLEEP_MODE_SEL_Msk				(0x3ul << ANAC_FL_SLEEP_MODE_SEL_Pos)
#define ANAC_FL_EXT_WAKEUP_SEL_Pos_3v			(2)            
#define ANAC_FL_EXT_WAKEUP_SEL_Msk_3v			(0x1ul << ANAC_FL_EXT_WAKEUP_SEL_Pos_3v)
#define ANAC_FL_SLEEP_CNT_EN_Pos				(3)            
#define ANAC_FL_SLEEP_CNT_EN_Msk				(0x1ul << ANAC_FL_SLEEP_CNT_EN_Pos)
#define ANAC_FL_CPU_RETENTION_EN_Pos			(4)            
#define ANAC_FL_CPU_RETENTION_EN_Msk			(0x1ul << ANAC_FL_CPU_RETENTION_EN_Pos)
#define ANAC_FL_LDO_ISOLATE_EN_Pos				(5)            
#define ANAC_FL_LDO_ISOLATE_EN_Msk				(0x1ul << ANAC_FL_LDO_ISOLATE_EN_Pos)
...
#define ANAC_FL_FLASH_BP_EN_Pos					(12)            
#define ANAC_FL_FLASH_BP_EN_Msk					(0x1ul << ANAC_FL_FLASH_BP_EN_Pos)
#define ANAC_FL_FLASH_LP_EN_Pos					(13)            
#define ANAC_FL_FLASH_LP_EN_Msk					(0x1ul << ANAC_FL_FLASH_LP_EN_Pos)
#define ANAC_FL_BUCK_BP_EN_Pos					(14)            
#define ANAC_FL_BUCK_BP_EN_Msk					(0x1ul << ANAC_FL_BUCK_BP_EN_Pos)
#define ANAC_FL_BUCK_EN_Pos						(15)           
#define ANAC_FL_BUCK_EN_Msk						(0x1ul << ANAC_FL_BUCK_EN_Pos)
#define ANAC_FL_DPLL_EN_Pos						(16)           
#define ANAC_FL_DPLL_EN_Msk						(0x1ul << ANAC_FL_DPLL_EN_Pos)
#define ANAC_FL_RCH_EN_Pos						(17)           
#define ANAC_FL_RCH_EN_Msk						(0x1ul << ANAC_FL_RCH_EN_Pos)
#define ANAC_FL_XTH_EN_Pos						(18)           
#define ANAC_FL_XTH_EN_Msk						(0x1ul << ANAC_FL_XTH_EN_Pos)
#define ANAC_FL_XTAL32K_EN_Pos_3v				(19)           
#define ANAC_FL_XTAL32K_EN_Msk_3v				(0x1ul << ANAC_FL_XTAL32K_EN_Pos_3v)
#define ANAC_FL_RC32K_EN_Pos_3v					(20)           
#define ANAC_FL_RC32K_EN_Msk_3v					(0x1ul << ANAC_FL_RC32K_EN_Pos_3v)
...
#define ANAC_CPU_POWER_CTL_Pos					(26)           
#define ANAC_CPU_POWER_CTL_Msk					(0x1ul << ANAC_CPU_POWER_CTL_Pos)
#define ANAC_PHY_POWER_CTL_Pos					(27)           
#define ANAC_PHY_POWER_CTL_Msk					(0x1ul << ANAC_PHY_POWER_CTL_Pos)
#define ANAC_LL_SRAM_POWER_CTL_Pos				(28)           
#define ANAC_LL_SRAM_POWER_CTL_Msk				(0x1ul << ANAC_LL_SRAM_POWER_CTL_Pos)
#define ANAC_FLASH_POWER_CTL_Pos				(29)           
#define ANAC_FLASH_POWER_CTL_Msk				(0x1ul << ANAC_FLASH_POWER_CTL_Pos)
#define ANAC_LDO_POWER_CTL_Pos					(30)           
#define ANAC_LDO_POWER_CTL_Msk					(0x1ul << ANAC_LDO_POWER_CTL_Pos)
#define ANAC_LDOL_POWER_CTL_Pos					(31)           
#define ANAC_LDOL_POWER_CTL_Msk					(0x1ul << ANAC_LDOL_POWER_CTL_Pos)


/*LP_INT_CTRL*/
#define ANAC_INT_LP_INT_EN_Pos					(0)
#define ANAC_INT_LP_INT_EN_Msk					(0x1ul << ANAC_INT_LP_INT_EN_Pos)
#define ANAC_INT_DP_FLAG_Pos					(1)
#define ANAC_INT_DP_FLAG_Msk					(0x1ul << ANAC_INT_DP_FLAG_Pos)
#define ANAC_INT_STANDBY_M1_FLAG_Pos			(2)
#define ANAC_INT_STANDBY_M1_FLAG_Msk			(0x1ul << ANAC_INT_STANDBY_M1_FLAG_Pos)
#define ANAC_INT_STANDBY_M0_FLAG_Pos			(3)
#define ANAC_INT_STANDBY_M0_FLAG_Msk			(0x1ul << ANAC_INT_STANDBY_M0_FLAG_Pos)
#define ANAC_INT_SRAM_RET_FLAG_Pos				(4)
#define ANAC_INT_SRAM_RET_FLAG_Msk				(0x1ul << ANAC_INT_SRAM_RET_FLAG_Pos)
#define ANAC_INT_SLEEP_TMR_INT_EN_Pos			(16)
#define ANAC_INT_SLEEP_TMR_INT_EN_Msk			(0x1ul << ANAC_INT_SLEEP_TMR_INT_EN_Pos)
#define ANAC_INT_SLEEP_TMR0_Pos					(17)
#define ANAC_INT_SLEEP_TMR0_Msk					(0x1ul << ANAC_INT_SLEEP_TMR0_Pos)
#define ANAC_INT_SLEEP_TMR1_Pos					(18)
#define ANAC_INT_SLEEP_TMR1_Msk					(0x1ul << ANAC_INT_SLEEP_TMR1_Pos)
#define ANAC_INT_SLEEP_TMR2_Pos					(19)
#define ANAC_INT_SLEEP_TMR2_Msk					(0x1ul << ANAC_INT_SLEEP_TMR2_Pos)
#define ANAC_INT_SLEEP_TMR_WK_EN_Pos			(20)
#define ANAC_INT_SLEEP_TMR_WK_EN_Msk			(0x1ul << ANAC_INT_SLEEP_TMR_WK_EN_Pos)

/*LP_DLY_CTRL_3V*/
#define ANAC_32KCLK_DLY_TIME_Pos				(0)
#define ANAC_32KCLK_DLY_TIME_Msk				(0x3FFul << ANAC_32KCLK_DLY_TIME_Pos)
#define ANAC_32KCLK_DLY_EN_Pos					(10)
#define ANAC_32KCLK_DLY_EN_Msk					(0x1ul << ANAC_32KCLK_DLY_EN_Pos)
#define ANAC_HPLDO_RDY_BYPASS_Pos				(11)
#define ANAC_HPLDO_RDY_BYPASS_Msk				(0x1ul << ANAC_HPLDO_RDY_BYPASS_Pos)
#define ANAC_LPLDOH_DLY_TIME_Pos_3v				(16)
#define ANAC_LPLDOH_DLY_TIME_Msk_3v				(0x3FFul << ANAC_LPLDOH_DLY_TIME_Pos_3v)

/*LP_PTAT_POLY*/
#define ANAC_PTAT_CORE_EN_Pos				(0)
#define ANAC_PTAT_CORE_EN_Msk				(0x1ul << ANAC_PTAT_CORE_EN_Pos)
#define ANAC_PTAT_TMP_TRIM_Pos				(1)
#define ANAC_PTAT_TMP_TRIM_Msk				(0x3ul << ANAC_PTAT_TMP_TRIM_Pos)
#define ANAC_PTAT_TRIM_Pos					(3)
#define ANAC_PTAT_TRIM_Msk					(0x7ul << ANAC_PTAT_TRIM_Pos)
#define ANAC_PTAT_FLT_SHIFT_EN_Pos			(6)
#define ANAC_PTAT_FLT_SHIFT_EN_Msk			(0x1ul << ANAC_PTAT_FLT_SHIFT_EN_Pos)
#define ANAC_PTAT_FLT_ACT_EN_Pos			(7)
#define ANAC_PTAT_FLT_ACT_EN_Msk			(0x1ul << ANAC_PTAT_FLT_ACT_EN_Pos)
#define ANAC_POLY_EN_Pos					(8)
#define ANAC_POLY_EN_Msk					(0x1ul << ANAC_POLY_EN_Pos)
#define ANAC_IPOLY_TRIM_Pos					(16)
#define ANAC_IPOLY_TRIM_Msk					(0x3ul << ANAC_IPOLY_TRIM_Pos)

/*LP_HP_LDO*/
#define ANAC_HPLDO_EN_Pos					(0)
#define ANAC_HPLDO_EN_Msk					(0x1ul << ANAC_HPLDO_EN_Pos)
#define ANAC_HPLDO_BYPASS_Pos				(2)
#define ANAC_HPLDO_BYPASS_Msk				(0x1ul << ANAC_HPLDO_BYPASS_Pos)
#define ANAC_HPLDO_TRIM_Pos					(3)
#define ANAC_HPLDO_TRIM_Msk					(0xFul << ANAC_HPLDO_TRIM_Pos)
#define ANAC_HPLDO_SEL_Pos					(9)
#define ANAC_HPLDO_SEL_Msk					(0x1ul << ANAC_HPLDO_SEL_Pos)
#define ANAC_HPLDO_FLASHLDO_BP_Pos_3v		(16)
#define ANAC_HPLDO_FLASHLDO_BP_Msk_3v		(0x1ul << ANAC_HPLDO_FLASHLDO_BP_Pos_3v)
#define ANAC_HPLDO_FLASHLDO_EN_Pos_3v		(17)
#define ANAC_HPLDO_FLASHLDO_EN_Msk_3v		(0x1ul << ANAC_HPLDO_FLASHLDO_EN_Pos_3v)
#define ANAC_HPLDO_FLASHLDO_LP_EN_Pos		(18)
#define ANAC_HPLDO_FLASHLDO_LP_EN_Msk		(0x1ul << ANAC_HPLDO_FLASHLDO_LP_EN_Pos)
#define ANAC_HPLDO_FLASHLDO_CAP_SEL_Pos		(19)
#define ANAC_HPLDO_FLASHLDO_CAP_SEL_Msk		(0x1ul << ANAC_HPLDO_FLASHLDO_CAP_SEL_Pos)
#define ANAC_HPLDO_FLASHLDO_TRIM_Pos		(20)
#define ANAC_HPLDO_FLASHLDO_TRIM_Msk		(0x7ul << ANAC_HPLDO_FLASHLDO_TRIM_Pos)
/*LP_LP_LDO_3V*/
#define ANAC_LPLDO_L_EN_Pos					(0)
#define ANAC_LPLDO_L_EN_Msk					(0x1ul << ANAC_LPLDO_L_EN_Pos)
#define ANAC_LPLDO_L_DVDD_SEL_Pos			(1)
#define ANAC_LPLDO_L_DVDD_SEL_Msk			(0xFul << ANAC_LPLDO_L_DVDD_SEL_Pos)
#define ANAC_LPLDO_H_EN_Pos_3v				(16)
#define ANAC_LPLDO_H_EN_Msk_3v				(0x1ul << ANAC_LPLDO_H_EN_Pos_3v)
#define ANAC_LPLDO_H_DVDD_SEL_Pos_3v		(17)
#define ANAC_LPLDO_H_DVDD_SEL_Msk_3v		(0xFul << ANAC_LPLDO_H_DVDD_SEL_Pos_3v)
#define ANAC_LPLDO_H_REF_TRIM_Pos_3v		(21)
#define ANAC_LPLDO_H_REF_TRIM_Msk_3v		(0x7ul << ANAC_LPLDO_H_REF_TRIM_Pos_3v)
#define ANAC_LPLDO_H_MODE_SEL_Pos_3v		(24)
#define ANAC_LPLDO_H_MODE_SEL_Msk_3v		(0x1ul << ANAC_LPLDO_H_MODE_SEL_Pos_3v)

/*LP_ANA_LDO*/
#define ANAC_ANA_LDO_EN_Pos					(0)
#define ANAC_ANA_LDO_EN_Msk					(0x1ul << ANAC_ANA_LDO_EN_Pos)
#define ANAC_ANA_LDO_TRIM_Pos				(3)
#define ANAC_ANA_LDO_TRIM_Msk				(0xFul << ANAC_ANA_LDO_TRIM_Pos)
/*LP_FSYN_LDO*/
#define ANAC_FSYN_LDO_EN_Pos				(0)
#define ANAC_FSYN_LDO_EN_Msk				(0x1ul << ANAC_FSYN_LDO_EN_Pos)
#define ANAC_FSYN_LDO_TRIM_Pos				(3)
#define ANAC_FSYN_LDO_TRIM_Msk				(0xFul << ANAC_FSYN_LDO_TRIM_Pos)
/*LP_SW*/
#define ANAC_HP_DVDD_PD_Pos					(0)
#define ANAC_HP_DVDD_PD_Msk					(0x1ul << ANAC_HP_DVDD_PD_Pos)
#define ANAC_HP_DVDD_EN_Pos					(1)
#define ANAC_HP_DVDD_EN_Msk					(0x1ul << ANAC_HP_DVDD_EN_Pos)
#define ANAC_DVDD_SRAM0_EN_Pos				(2)
#define ANAC_DVDD_SRAM0_EN_Msk				(0x1ul << ANAC_DVDD_SRAM0_EN_Pos)
#define ANAC_DVDD_SRAM1_EN_Pos				(3)
#define ANAC_DVDD_SRAM1_EN_Msk				(0x1ul << ANAC_DVDD_SRAM1_EN_Pos)
#define ANAC_DVDD_LPLDO_EN_Pos				(4)
#define ANAC_DVDD_LPLDO_EN_Msk				(0x1ul << ANAC_DVDD_LPLDO_EN_Pos)
#define ANAC_VDD_FLASH_EN_Pos				(5)
#define ANAC_VDD_FLASH_EN_Msk				(0x1ul << ANAC_VDD_FLASH_EN_Pos)
#define ANAC_DVDD_DLL_EN_Pos				(6)
#define ANAC_DVDD_DLL_EN_Msk				(0x1ul << ANAC_DVDD_DLL_EN_Pos)
#define ANAC_DVDD_PHY_EN_Pos				(7)
#define ANAC_DVDD_PHY_EN_Msk				(0x1ul << ANAC_DVDD_PHY_EN_Pos)
#define ANAC_DVDD_CPU_EN_Pos				(8)
#define ANAC_DVDD_CPU_EN_Msk				(0x1ul << ANAC_DVDD_CPU_EN_Pos)

/*LP_BUCK_3V*/
#define ANAC_BUCK_BYPASS_EN_Pos_3v			(0)
#define ANAC_BUCK_BYPASS_EN_Msk_3v			(0x1ul << ANAC_BUCK_BYPASS_EN_Pos_3v)
#define ANAC_BUCK_EN_Pos_3v					(1)
#define ANAC_BUCK_EN_Msk_3v					(0x1ul << ANAC_BUCK_EN_Pos_3v)
#define ANAC_BUCK_VOUT_Pos_3v				(2)
#define ANAC_BUCK_VOUT_Msk_3v				(0xful << ANAC_BUCK_VOUT_Pos_3v)
#define ANAC_BUCK_IMAX_Pos_3v				(6)
#define ANAC_BUCK_IMAX_Msk_3v				(0x7ul << ANAC_BUCK_IMAX_Pos_3v)
#define ANAC_BUCK_IMAX_CAL_Pos_3v			(9)
#define ANAC_BUCK_IMAX_CAL_Msk_3v			(0x1Ful << ANAC_BUCK_IMAX_CAL_Pos_3v)
#define ANAC_BUCK_ZERO_CAL_Pos_3v			(14)
#define ANAC_BUCK_ZERO_CAL_Msk_3v			(0x1Ful << ANAC_BUCK_ZERO_CAL_Pos_3v)
#define ANAC_BUCK_DLY_MODE_EN_Pos_3v		(19)
#define ANAC_BUCK_DLY_MODE_EN_Msk_3v		(0x1ul << ANAC_BUCK_DLY_MODE_EN_Pos_3v)
#define ANAC_BUCK_TEST_EN_Pos				(20)
#define ANAC_BUCK_TEST_EN_Msk				(0x1ul << ANAC_BUCK_TEST_EN_Pos)
#define ANAC_BUCK_DEBOUNCE_EN_Pos_3v		(21)
#define ANAC_BUCK_DEBOUNCE_EN_Msk_3v		(0x1ul << ANAC_BUCK_DEBOUNCE_EN_Pos_3v)
#define ANAC_BUCK_CAL_EN_Pos_3v				(22)
#define ANAC_BUCK_CAL_EN_Msk_3v				(0x3ul << ANAC_BUCK_CAL_EN_Pos_3v)
#define ANAC_BUCK_CAL_OUT_Pos				(24)
#define ANAC_BUCK_CAL_OUT_Msk				(0x1ul << ANAC_BUCK_CAL_OUT_Pos)
#define ANAC_BUCK_VOL_LIMIT_EN_Pos_3v		(25)
#define ANAC_BUCK_VOL_LIMIT_EN_Msk_3v		(0x1ul << ANAC_BUCK_VOL_LIMIT_EN_Pos_3v)

/*LP_ADC_LDO*/
#define ANAC_ADC_LDO_EN_Pos					(0)
#define ANAC_ADC_LDO_EN_Msk					(0x1ul << ANAC_ADC_LDO_EN_Pos)
#define ANAC_ADC_LDO_TRIM_Pos				(3)
#define ANAC_ADC_LDO_TRIM_Msk				(0xFul << ANAC_ADC_LDO_TRIM_Pos)

/*LP_RFFE_LDO*/
#define ANAC_RFFE_LDO_EN_Pos				(0)
#define ANAC_RFFE_LDO_EN_Msk				(0x1ul << ANAC_RFFE_LDO_EN_Pos)
#define ANAC_RFFE_LDO_TRIM_Pos				(3)
#define ANAC_RFFE_LDO_TRIM_Msk				(0xFul << ANAC_RFFE_LDO_TRIM_Pos)
/*LP_VCO_LDO*/
#define ANAC_VCO_LDO_EN_Pos					(0)
#define ANAC_VCO_LDO_EN_Msk					(0x1ul << ANAC_VCO_LDO_EN_Pos)
#define ANAC_VCO_LDO_TRIM_Pos				(3)
#define ANAC_VCO_LDO_TRIM_Msk				(0xFul << ANAC_VCO_LDO_TRIM_Pos)

/*ANA_DFT*/
#define ANAC_DFT_BUF_BYPASS_Pos				(0)
#define ANAC_DFT_BUF_BYPASS_Msk				(0x1ul << ANAC_DFT_BUF_BYPASS_Pos)
#define ANAC_DFT_FLAG_SEL_Pos				(1)
#define ANAC_DFT_FLAG_SEL_Msk				(0x3ul << ANAC_DFT_FLAG_SEL_Pos)
#define ANAC_DFT_CLK_SEL_Pos				(3)
#define ANAC_DFT_CLK_SEL_Msk				(0x7ul << ANAC_DFT_CLK_SEL_Pos)
#define ANAC_DFT_I_SEL_Pos					(6)
#define ANAC_DFT_I_SEL_Msk					(0x1ul << ANAC_DFT_I_SEL_Pos)
#define ANAC_DFT_V_SEL_Pos					(7)
#define ANAC_DFT_V_SEL_Msk					(0xFul << ANAC_DFT_V_SEL_Pos)
#define ANAC_DFT_FLAG_OUTPUT_EN_Pos			(11)
#define ANAC_DFT_FLAG_OUTPUT_EN_Msk			(0x1ul << ANAC_DFT_FLAG_OUTPUT_EN_Pos)
#define ANAC_DFT_CLK_OUTPUT_EN_Pos			(12)
#define ANAC_DFT_CLK_OUTPUT_EN_Msk			(0x1ul << ANAC_DFT_CLK_OUTPUT_EN_Pos)
#define ANAC_DFT_I_OUTPUT_EN_Pos			(13)
#define ANAC_DFT_I_OUTPUT_EN_Msk			(0x1ul << ANAC_DFT_I_OUTPUT_EN_Pos)
#define ANAC_DFT_V_OUTPUT_EN_Pos			(14)
#define ANAC_DFT_V_OUTPUT_EN_Msk			(0x1ul << ANAC_DFT_V_OUTPUT_EN_Pos)
#define ANAC_DFT_PAD_TEST_SEL_Pos			(15)
#define ANAC_DFT_PAD_TEST_SEL_Msk			(0x3ul << ANAC_DFT_PAD_TEST_SEL_Pos)
#define ANAC_DFT_BATTERY_TEST_EN_Pos		(22)
#define ANAC_DFT_BATTERY_TEST_EN_Msk		(0x1ul << ANAC_DFT_BATTERY_TEST_EN_Pos)
#define ANAC_DFT_BATTERY_TEST_SEL_Pos		(23)
#define ANAC_DFT_BATTERY_TEST_SEL_Msk		(0x1ul << ANAC_DFT_BATTERY_TEST_SEL_Pos)
#define ANAC_DFT_BATTERY_TEST_TRIM_Pos		(24)
#define ANAC_DFT_BATTERY_TEST_TRIM_Msk		(0xfful << ANAC_DFT_BATTERY_TEST_TRIM_Pos)

/*ANA_MISC_3V*/
#define ANAC_MISC_RST_VREF_TRIM_Pos_3v		(0)
#define ANAC_MISC_RST_VREF_TRIM_Msk_3v		(0x7ul << ANAC_MISC_RST_VREF_TRIM_Pos_3v)
#define ANAC_MISC_PMU_LDO_TST_Pos			(3)
#define ANAC_MISC_PMU_LDO_TST_Msk			(0x1ul << ANAC_MISC_PMU_LDO_TST_Pos)
#define ANAC_MISC_PMU_VBG_BUF_EN_Pos		(4)
#define ANAC_MISC_PMU_VBG_BUF_EN_Msk		(0x1ul << ANAC_MISC_PMU_VBG_BUF_EN_Pos)
#define ANAC_MISC_LPLDO_LEVEL_SHIFT_EN_Pos_3v	(6)
#define ANAC_MISC_LPLDO_LEVEL_SHIFT_EN_Msk_3v	(0x1ul << ANAC_MISC_LPLDO_LEVEL_SHIFT_EN_Pos_3v)
#define ANAC_MISC_HPLDO_LEVEL_SHIFT_EN_Pos	(7)
#define ANAC_MISC_HPLDO_LEVEL_SHIFT_EN_Msk	(0x1ul << ANAC_MISC_HPLDO_LEVEL_SHIFT_EN_Pos)
#define ANAC_MISC_FLASH_PAD_PUEN_Pos        (14)
#define ANAC_MISC_FLASH_PAD_PUEN_Msk        (0x3Ful << ANAC_MISC_FLASH_PAD_PUEN_Pos)
#define ANAC_MISC_FLASH_PAD_PDEN_Pos        (20)
#define ANAC_MISC_FLASH_PAD_PDEN_Msk        (0x3Ful << ANAC_MISC_FLASH_PAD_PDEN_Pos)
#define ANAC_MISC_USB_EN_Pos                (26)
#define ANAC_MISC_USB_EN_Msk                (0x1ul << ANAC_MISC_USB_EN_Pos)
#define ANAC_MISC_USB_DP_PU_Pos             (27)
#define ANAC_MISC_USB_DP_PU_Msk             (0x1ul << ANAC_MISC_USB_DP_PU_Pos)
#define ANAC_MISC_USB_DM_PU_Pos             (28)
#define ANAC_MISC_USB_DM_PU_Msk             (0x1ul << ANAC_MISC_USB_DM_PU_Pos)

/*ANA_RESERVED_3V*/
/*ACT_32K_CTRL*/
#define ANAC_ACT_32K_EN_Pos					(0)
#define ANAC_ACT_32K_EN_Msk					(0x1ul << ANAC_ACT_32K_EN_Pos)
#define ANAC_ACT_32K_SEL_Pos				(1)
#define ANAC_ACT_32K_SEL_Msk				(0x1ul << ANAC_ACT_32K_SEL_Pos)
#define ANAC_ACT_32K_UP_DONE_Pos			(3)
#define ANAC_ACT_32K_UP_DONE_Msk			(0x1ul << ANAC_ACT_32K_UP_DONE_Pos)
#define ANAC_ACT_32K_FINE_OFFSET_Pos		(12)
#define ANAC_ACT_32K_FINE_OFFSET_Msk		(0x3FFul << ANAC_ACT_32K_FINE_OFFSET_Pos)
#define ANAC_ACT_32K_FINE_CORRECT_Pos		(22)
#define ANAC_ACT_32K_FINE_CORRECT_Msk		(0x3FFul << ANAC_ACT_32K_FINE_CORRECT_Pos)

/*CPU_ADDR_REMAP_CTRL*/
#define ANAC_CPU_REMAP_ADR_Pos				(0)
#define ANAC_CPU_REMAP_ADR_Msk				(0xFFFFFFul << ANAC_CPU_REMAP_ADR_Pos)
#define ANAC_CPU_ADR_REMAP_EN_Pos			(31)
#define ANAC_CPU_ADR_REMAP_EN_Msk			(0x1ul << ANAC_CPU_ADR_REMAP_EN_Pos)

/*RCL_HW_CAL_CTRL*/
#define ANAC_RCL_HW_CAL_TIME_Pos			(0)
#define ANAC_RCL_HW_CAL_TIME_Msk			(0xFFul << ANAC_RCL_HW_CAL_TIME_Pos)
#define ANAC_RCL_HW_CAL_EN_Pos				(8)
#define ANAC_RCL_HW_CAL_EN_Msk				(0x1ul << ANAC_RCL_HW_CAL_EN_Pos)
#define ANAC_RCL_HW_CAL_BUSY_Pos			(9)
#define ANAC_RCL_HW_CAL_BUSY_Msk			(0x1ul << ANAC_RCL_HW_CAL_BUSY_Pos)
...
typedef struct {                                //offset
    ...
    __IO uint32_t  EF_VERIFY_DEBUG1         ;   //0x68
    __IO uint32_t  EF_VERIFY_DEBUG2         ;   //0x6C
    __IO uint32_t  EF_VERIFY_DEBUG3         ;   //0x70
    __IO uint32_t  EF_VERIFY_DEBUG4         ;   //0x74
    __IO uint32_t  EF_FLASH_PERMISSION      ;   //0x78
} EFUSE_T;
...
#define EFUSE_DAT_EFUSEDAT_DAT_CONFIRM_Pos              (8)          
#define EFUSE_DAT_EFUSEDAT_DAT_CONFIRM_Msk              (0xfful << EFUSE_DAT_EFUSEDAT_DAT_CONFIRM_Pos)
...
//EFUSE_OP_ERROR
#define EFUSE_OP_ERROR_OP_ERROR_Pos                     (0)
#define EFUSE_OP_ERROR_OP_ERROR_Msk                     (0x1ul << EFUSE_OP_ERROR_OP_ERROR_Pos)

//EFUSE_VERIFY_DEBUG1
#define EFUSE_VERIFY_DEBUG1_VERIFY_DBG_KEY1_Pos         (0)
#define EFUSE_VERIFY_DEBUG1_VERIFY_DBG_KEY1_Msk         (0xfffffffful << EFUSE_VERIFY_DEBUG1_VERIFY_DBG_KEY1_Pos)

//EFUSE_VERIFY_DEBUG2
#define EFUSE_VERIFY_DEBUG2_VERIFY_DBG_KEY2_Pos         (0)
#define EFUSE_VERIFY_DEBUG2_VERIFY_DBG_KEY2_Msk         (0xfffffffful << EFUSE_VERIFY_DEBUG2_VERIFY_DBG_KEY2_Pos)

//EFUSE_VERIFY_DEBUG3
#define EFUSE_VERIFY_DEBUG3_VERIFY_DBG_KEY3_Pos         (0)
#define EFUSE_VERIFY_DEBUG3_VERIFY_DBG_KEY3_Msk         (0xfffffffful << EFUSE_VERIFY_DEBUG3_VERIFY_DBG_KEY3_Pos)

//EFUSE_VERIFY_DEBUG4
#define EFUSE_VERIFY_DEBUG4_VERIFY_DBG_KEY4_Pos         (0)
#define EFUSE_VERIFY_DEBUG4_VERIFY_DBG_KEY4_Msk         (0xfffffffful << EFUSE_VERIFY_DEBUG4_VERIFY_DBG_KEY4_Pos)

//EFUSE_FLASH_PERMISSION
#define EFUSE_FLASH_PERMISSION_CTRL_Pos                 (0)
#define EFUSE_FLASH_PERMISSION_CTRL_Msk                 (0x1ul << EFUSE_FLASH_PERMISSION_CTRL_Pos)
...
/*CNTL1*/
#define USB_DMA_REQUEST_Pos             (0)
#define USB_DMA_REQUEST_Msk             (0x1ul << USB_DMA_REQUEST_Pos)
#define USB_DMA_DIRECTION_Pos           (1)
#define USB_DMA_DIRECTION_Msk           (0x1ul << USB_DMA_DIRECTION_Pos)
#define USB_DMA_MODE_SEL_Pos            (2)
#define USB_DMA_MODE_SEL_Msk            (0x1ul << USB_DMA_MODE_SEL_Pos)
#define USB_DMA_EP_NUM_Pos              (4)
...
typedef struct {
    ...
    __IO uint32_t R01_INT; 			// 0x500204C4
    __IO uint32_t R02_TMR_CTL; 			// 0x500204C8
    __IO uint32_t R03_RX_ADDR_L;    	// 0x500204CC
    __IO uint32_t R04_RX_CTL; 			// 0x500204D0
    __IO uint32_t R05_TX_ADDR_L;    	// 0x500204D4
    __IO uint32_t R06_TX_CTL;   		// 0x500204D8
    __IO uint32_t R07_SRAM_CTL;     	// 0x500204DC
    __IO uint32_t R08_RX_ADDR1_L;         // 0x500204E0
    __IO uint32_t R09_RX_ADDR2_L;         // 0x500204E4
    __IO uint32_t R0A_RX_ADDR3_L;         // 0x500204E8
	__IO uint32_t R0B_RX_ADDR4_L;         // 0x500204EC
    __IO uint32_t R0C_RX_ADDR5_L;         // 0x500204F0
    __IO uint32_t R0D_RX_ADDR6_L;         // 0x500204F4
    __IO uint32_t R0E_RX_ADDR7_L;         // 0x500204F8
    __IO uint32_t R0F_RX_ADDR_H;      	  // 0x500204FC
    __IO uint32_t R10_RX_ADDR_EN;         // 0x50020500
	__IO uint32_t R11_CFG;         		// 0x50020504
}PRI_RF_T;
...
#define R00_CTL_CRC_ACCESS_ADR_Msk                          (0x1ul<<R00_CTL_CRC_ACCESS_ADR_Pos)    /* [15] 8bits */
#define R00_CTL_CRC24_EN_Pos                          		14
#define R00_CTL_CRC24_EN_Msk                          		(0x1ul<<R00_CTL_CRC24_EN_Pos)    	/* [14] 1bits */
...
#define R00_CTL_NRF_ENHANCE_Msk                             (0x1ul<<R00_CTL_NRF_ENHANCE_Pos)     /* [7] 1bit*/
...
#define R01_INT_RX_LENGTH_ERR_Pos                 			26
#define R01_INT_RX_LENGTH_ERR_Msk                			(0x1ul<<R01_INT_RX_LENGTH_ERR_Pos)
#define R01_INT_RX_ACCADDR_ERR_Pos                			25
#define R01_INT_RX_ACCADDR_ERR_Msk               			(0x1ul<<R01_INT_RX_ACCADDR_ERR_Pos)
#define R01_INT_RX_ACCADDR_ERR_MASK_Pos                		23
#define R01_INT_RX_ACCADDR_ERR_MASK_Msk               		(0x1ul<<R01_INT_RX_ACCADDR_ERR_MASK_Pos)
#define R01_INT_RX_LENGTH_ERR_MASK_Pos                 		22
#define R01_INT_RX_LENGTH_ERR_MASK_Msk                		(0x1ul<<R01_INT_RX_LENGTH_ERR_MASK_Pos)
...
#define R01_INT_EXIT_RX_Pos                             	16
#define R01_INT_EXIT_RX_Msk                             	(0x1ul<<R01_INT_EXIT_RX_Pos)
...
#define R01_INT_RX_CRC_ERR_Pos                    		  	12		
#define R01_INT_RX_CRC_ERR_Msk                     		  	(0x1ul<<R01_INT_RX_CRC_ERR_Pos)     		/* [12] 1bit*/
#define R01_INT_TX_TIMEOUT_IRQ_Pos                      	11		
#define R01_INT_TX_TIMEOUT_IRQ_Msk                      	(0x1ul<<R01_INT_TX_TIMEOUT_IRQ_Pos) 		/* [11] 1bit*/
#define R01_INT_TX_IRQ_Pos                            		10		
#define R01_INT_TX_IRQ_Msk                             		(0x1ul<<R01_INT_TX_IRQ_Pos)         		/* [10] 1bit*/
#define R01_INT_RX_IRQ_Pos                            		9		
#define R01_INT_RX_IRQ_Msk                              	(0x1ul<<R01_INT_RX_IRQ_Pos)         		/* [9] 1bit*/
#define R01_INT_IRQ_CLR_EN_Pos                          	8		
#define R01_INT_IRQ_CLR_EN_Msk                          	(0x1ul<<R01_INT_IRQ_CLR_EN_Pos)     		/* [8] 1bit*/
#define R01_INT_RX_CRC_ERR_MASK_Pos                     	7	
#define R01_INT_RX_CRC_ERR_MASK_Msk                     	(0x1ul<<R01_INT_RX_CRC_ERR_MASK_Pos)  	/* [7] 1bit*/
#define R01_INT_PID_ERR_MASK_Pos                        	6	
#define R01_INT_PID_ERR_MASK_Msk                        	(0x1ul<<R01_INT_PID_ERR_MASK_Pos)  	/* [6] 1bit*/
#define R01_INT_TX_TIMEOUT_IRQ_MASK_Pos              		5
#define R01_INT_TX_TIMEOUT_IRQ_MASK_Msk               		(0x1ul<<R01_INT_TX_TIMEOUT_IRQ_MASK_Pos)  /* [5] 1bit*/
#define R01_INT_TX_IRQ_MASK_Pos                         	4
#define R01_INT_TX_IRQ_MASK_Msk                         	(0x1ul<<R01_INT_TX_IRQ_MASK_Pos)          /* [4] 1bit*/
#define R01_INT_RX_IRQ_MASK_Pos                         	3
#define R01_INT_RX_IRQ_MASK_Msk                         	(0x1ul<<R01_INT_RX_IRQ_MASK_Pos)          /* [3] 1bit*/
#define R01_INT_MULTI_RX_ACC_ADR_Pos                       	0
#define R01_INT_MULTI_RX_ACC_ADR_Msk                       	(0x7ul<<R01_INT_MULTI_RX_ACC_ADR_Pos)        /* [2:0] 2bits*/
...
#define R04_RX_CTL_RX_HEADER1_Msk                          (0xFFul<<R04_RX_CTL_RX_HEADER1_Pos)            /* [16:31] 1bits*/
#define R04_RX_CTL_RX_HEADER_Pos                           16
#define R04_RX_CTL_RX_HEADER_Msk                           (0xFFul<<R04_RX_CTL_RX_HEADER_Pos)            /* [16:31] 1bits*/
#define R04_RX_CTL_RX_FEC_Pos                              15
#define R04_RX_CTL_RX_FEC_Msk                              (0x1ul<<R04_RX_CTL_RX_FEC_Pos)            /* [11] 1bits*/
#define R04_RX_CTL_TX_FEC_Pos                         		14
#define R04_RX_CTL_TX_FEC_Msk                          		(0x1ul<<R04_RX_CTL_TX_FEC_Pos)            /* [11] 1bits*/
#define R04_RX_CTL_CI_MODE_Pos                        		12
#define R04_RX_CTL_CI_MODE_Msk                          	(0x3ul<<R04_RX_CTL_CI_MODE_Pos)            /* [11] 1bits*/
#define R04_RX_CTL_NORMAL_M1_Pos                         	11
#define R04_RX_CTL_NORMAL_M1_Msk                          	(0x1ul<<R04_RX_CTL_NORMAL_M1_Pos)            /* [11] 1bits*/
#define R04_RX_CTL_HDR_LEN_NUMB_Pos                      	9
#define R04_RX_CTL_HDR_LEN_NUMB_Msk                       	(0x3ul<<R04_RX_CTL_HDR_LEN_NUMB_Pos)            /* [9:10] 2bits*/
#define R04_RX_CTL_HDR_LEN_EXIST_Pos                     	8
#define R04_RX_CTL_HDR_LEN_EXIST_Msk                      	(0x1ul<<R04_RX_CTL_HDR_LEN_EXIST_Pos)            /* [8] 1bits*/
#define R04_RX_CTL_M8B_Pos                            		0
#define R04_RX_CTL_M8B_Msk                             		(0xFFul<<R04_RX_CTL_M8B_Pos)            		   /* [7:0] 8bits*/
/*R05_TX_ADDR_L*/																									   
#define R05_TX_ADDR_L_L32B_Pos                            	0		                                       
#define R05_TX_ADDR_L_L32B_Msk                             	(0xFFFFFFFFul<<R05_TX_ADDR_L_L32B_Pos)      		   /* [31:0] 32bits*/
/*R06_TX_CTL*/																										   
#define R06_TX_CTL_RX_HEADER1_Pos                          24
#define R06_TX_CTL_RX_HEADER1_Msk                          (0xFFul<<R06_TX_CTL_RX_HEADER1_Pos)            /* [24:31] 8bits*/
#define R06_TX_CTL_RX_HEADER_Pos                           16
#define R06_TX_CTL_RX_HEADER_Msk                           (0xFFul<<R06_TX_CTL_RX_HEADER_Pos)            /* [16:23] 8bits*/
#define R06_TX_CTL_MAX_LENGTH_EN_Pos                       15		                                       
#define R06_TX_CTL_MAX_LENGTH_EN_Msk                       (0x1ul<<R06_TX_CTL_MAX_LENGTH_EN_Pos)            /* [15] 1bits*/
#define R06_TX_CTL_WHITENING_INIT_Pos                      8		                                       
#define R06_TX_CTL_WHITENING_INIT_Msk                      (0x7Ful<<R06_TX_CTL_WHITENING_INIT_Pos)           /* [14:8] 7bits*/
#define R06_TX_CTL_M8B_Pos                           		0		                                       
#define R06_TX_CTL_M8B_Msk                             		(0xFFul<<R06_TX_CTL_M8B_Pos)            		   /* [7:0] 8bits*/
/*R07_SRAM_CTL*/
...
/*R0F_RX_ADDR_H*/
#define R0F_RX_ADDR4_M8B_Pos                            	24
#define R0F_RX_ADDR4_M8B_Msk                             	(0xFFul<<R0F_RX_ADDR4_M8B_Pos)            		   /* [7:0] 8bits*/
#define R0F_RX_ADDR3_M8B_Pos                            	16
#define R0F_RX_ADDR3_M8B_Msk                             	(0xFFul<<R0F_RX_ADDR3_M8B_Pos)            		   /* [7:0] 8bits*/
#define R0F_RX_ADDR2_M8B_Pos                            	8
#define R0F_RX_ADDR2_M8B_Msk                             	(0xFFul<<R0F_RX_ADDR2_M8B_Pos)            		   /* [7:0] 8bits*/
#define R0F_RX_ADDR1_M8B_Pos                            	0
#define R0F_RX_ADDR1_M8B_Msk                             	(0xFFul<<R0F_RX_ADDR1_M8B_Pos)            		   /* [7:0] 8bits*/

/*R10_RX_ADDR_EN*/
#define R10_RX_ADDR7_EN_Pos                            		31
#define R10_RX_ADDR7_EN_Msk                             	(0x1ul<<R0F_RX_ADDR7_EN_Pos)            		   /* [7:0] 8bits*/
#define R10_RX_ADDR6_EN_Pos                            		30
#define R10_RX_ADDR6_EN_Msk                             	(0x1ul<<R0F_RX_ADDR6_EN_Pos)            		   /* [7:0] 8bits*/
#define R10_RX_ADDR5_EN_Pos                            		29
#define R10_RX_ADDR5_EN_Msk                             	(0x1ul<<R0F_RX_ADDR5_EN_Pos)            		   /* [7:0] 8bits*/
#define R10_RX_ADDR4_EN_Pos                            		28
#define R10_RX_ADDR4_EN_Msk                             	(0x1ul<<R0F_RX_ADDR4_EN_Pos)            		   /* [7:0] 8bits*/
#define R10_RX_ADDR3_EN_Pos                            		27
#define R10_RX_ADDR3_EN_Msk                             	(0x1ul<<R0F_RX_ADDR3_EN_Pos)            		   /* [7:0] 8bits*/
#define R10_RX_ADDR2_EN_Pos                            		26
#define R10_RX_ADDR2_EN_Msk                             	(0x1ul<<R0F_RX_ADDR2_EN_Pos)            		   /* [7:0] 8bits*/
#define R10_RX_ADDR1_EN_Pos                            		25
#define R10_RX_ADDR1_EN_Msk                             	(0x1ul<<R0F_RX_ADDR1_EN_Pos)            		   /* [7:0] 8bits*/
#define R10_RX_ADDR0_EN_Pos                            		24
#define R10_RX_ADDR0_EN_Msk                             	(0x1ul<<R0F_RX_ADDR0_EN_Pos)            		   /* [7:0] 8bits*/
#define R10_RX_ADDR7_M8B_Pos                            	16
#define R10_RX_ADDR7_M8B_Msk                             	(0xFFul<<R0F_RX_ADDR3_M8B_Pos)            		   /* [7:0] 8bits*/
#define R10_RX_ADDR6_M8B_Pos                            	8
#define R10_RX_ADDR6_M8B_Msk                             	(0xFFul<<R0F_RX_ADDR2_M8B_Pos)            		   /* [7:0] 8bits*/
#define R10_RX_ADDR5_M8B_Pos                            	0
#define R10_RX_ADDR5_M8B_Msk                             	(0xFFul<<R0F_RX_ADDR1_M8B_Pos)            		   /* [7:0] 8bits*/


/*R11_CFG*/
#define R11_CFG_NRF_PRE_SEL_Pos                            25
#define R11_CFG_NRF_PRE_SEL_Msk                            (0x1ul<<R11_CFG_NRF_PRE_SEL_Pos)             /* [25] 2bits*/
#define R11_CFG_RX_DATA_REV_EN_Pos                         24
#define R11_CFG_RX_DATA_REV_EN_Msk                         (0x1ul<<R11_CFG_RX_DATA_REV_EN_Pos)          /* [24] 2bits*/
#define R11_CFG_PRE_SYNC_12B_EN_Pos                        23
#define R11_CFG_PRE_SYNC_12B_EN_Msk                        (0x1ul<<R11_CFG_PRE_SYNC_12B_EN_Pos)         /* [23] 2bits*/
#define R11_CFG_PRE_SYNC_8B_EN_Pos                         22
#define R11_CFG_PRE_SYNC_8B_EN_Msk                         (0x1ul<<R11_CFG_PRE_SYNC_8B_EN_Pos)          /* [22] 2bits*/
#define R11_CFG_PRE_SYNC_4B_EN_Pos                         21
#define R11_CFG_PRE_SYNC_4B_EN_Msk                         (0x1ul<<R11_CFG_PRE_SYNC_4B_EN_Pos)          /* [21] 2bits*/
#define R11_CFG_PRE_SYNC_EN_Pos                           	20
#define R11_CFG_PRE_SYNC_EN_Msk                           	(0x1ul<<R11_CFG_PRE_SYNC_EN_Pos)            /* [20] 2bits*/
#define R11_CFG_250K_MODE_EN_Pos                           	19
#define R11_CFG_250K_MODE_EN_Msk                           	(0x1ul<<R11_CFG_250K_MODE_EN_Pos)           /* [19] 2bits*/
#define R11_CFG_B250K_PRE_SEL_Pos                           18
#define R11_CFG_B250K_PRE_SEL_Msk                           (0x1ul<<R11_CFG_B250K_PRE_SEL_Pos)            /* [18] 2bits*/
#define R11_CFG_LQI_EN_Pos                           		17
#define R11_CFG_LQI_EN_Msk                           		(0x1ul<<R11_CFG_LQI_EN_Pos)             	/* [17] 2bits*/
#define R11_CFG_RX_PID_MANUAL_Pos                           15
#define R11_CFG_RX_PID_MANUAL_Msk                           (0x3ul<<R11_CFG_RX_PID_MANUAL_Pos)             /* [15:16] 2bits*/
#define R11_CFG_TX_PID_MANUAL_Pos                           13
#define R11_CFG_TX_PID_MANUAL_Msk                           (0x3ul<<R11_CFG_TX_PID_MANUAL_Pos)             /* [13:14] 2bits*/
#define R11_CFG_PREAM_2BYTE_EN_Pos                          12
#define R11_CFG_PREAM_2BYTE_EN_Msk                          (0x1ul<<R11_CFG_PREAM_2BYTE_EN_Pos)            /* 12 1bits*/
#define R11_CFG_B250K_INVERT_EN_Pos                         11
#define R11_CFG_B250K_INVERT_EN_Msk                         (0x1ul<<R11_CFG_B250K_INVERT_EN_Pos)            /* 11 1bits*/
#define R11_CFG_B250K_SCR_INIT_VALUE_Pos                     9
#define R11_CFG_B250K_SCR_INIT_VALUE_Msk                    (0x3ul<<R11_CFG_B250K_SCR_INIT_VALUE_Pos)        /* [9:10] 2bits*/
#define R11_CFG_B250K_PREAM_Pos                              6
#define R11_CFG_B250K_PREAM_Msk                            	(0x7ul<<R11_CFG_B250K_PREAM_Pos)         /* [6:8] 3bits*/
#define R11_CFG_B250K_MODE_Pos                              5
#define R11_CFG_B250K_MODE_Msk                            	(0x1ul<<R11_CFG_B250K_MODE_Pos)          /* [5]bits*/
#define R11_CFG_ADDR_ERR_THR_Pos                            2
#define R11_CFG_ADDR_ERR_THR_Msk                            (0x7ul<<R11_CFG_ADDR_ERR_THR_Pos)      /* [2:4] 3bits*/
#define R11_CFG_PID_MANUAL_EN_Pos                           1
#define R11_CFG_PID_MANUAL_EN_Msk                           (0x1ul<<R11_CFG_PID_MANUAL_EN_Pos)   /* [1] 1bit*/
#define R11_CFG_ADDR_SCR_DIS_Pos                           	0
#define R11_CFG_ADDR_SCR_DIS_Msk                           	(0x1ul<<R11_CFG_ADDR_SCR_DIS_Pos)    /* [0] 1bit*/
...
#define P3_BASE                (GPIO_BASE        + 0x000000C0UL) //0x40020050-0x4002005F
...
#define PRI_RF_BASE            (BLE_PERIPH_BASE  + 0X00000400UL) //0x50020400-0x500204dc
/******************************************************************************/
...
/* Undefine the default NVIC_SystemReset macro, and directly re-implement a new function for workaround here */
#ifdef NVIC_SystemReset
  #undef NVIC_SystemReset
#endif
__NO_RETURN __STATIC_FORCEINLINE void NVIC_SystemReset(void)
{
  /*
   * (Workaround) Clear an additional reserved (default 1) flag to
   * indicate we are doing System Reset operation
   */
