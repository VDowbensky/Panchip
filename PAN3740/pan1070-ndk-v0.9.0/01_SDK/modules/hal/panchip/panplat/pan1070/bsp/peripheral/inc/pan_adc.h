...
#define ADC_INPUTRANGE_HIGH             (1UL)                       		/*!< ADC input range 0v ~ VBAT */
#define ADC_INPUTRANGE_LOW              (0UL)                       		/*!< ADC input range 0v ~ 1.2V (ADC_VBG) */    
...
#define ADC_TRIGGER_BY_EXT_PIN          (0UL << ADC_CTL_HWTRGSEL_Pos)       /*!< ADC trigger by STADC pin */
