...
// <q> Enable Power Test
#define CONFIG_POWER_TEST_EN                                0

// <o> Set Adv Interval (in ms)
#define CONFIG_ADV_INTRVL_MS                                30

// <o> Set Connection Interval (in ms)
#define CONFIG_CONN_INTRVL_MS                               1000

// <q> Enable Slave Connection Latency
#define CONFIG_CONN_LATENCY_EN                              0
...
#define configTOTAL_HEAP_SIZE                               6100
...
// <i> Note that partition size should be multiple of 4KB!
#define CONFIG_FLASH_PARTITION_APP_SIZE_KB                  224
