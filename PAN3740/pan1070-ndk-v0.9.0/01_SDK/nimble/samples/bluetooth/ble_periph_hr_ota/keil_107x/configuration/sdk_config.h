...
#define configTOTAL_HEAP_SIZE                               6400
...
#define MYNEWT_VAL_BLE_TRANSPORT_ACL_FROM_LL_COUNT          6
...
// <i> Note that partition size should be multiple of 4KB!
#define CONFIG_FLASH_PARTITION_APP_SIZE_KB                  220

// <o> App Backup Flash Partition Size (KB)
// <i> Note that partition size should be multiple of 4KB!
#define CONFIG_FLASH_PARTITION_APP_BACKUP_SIZE_KB           220
