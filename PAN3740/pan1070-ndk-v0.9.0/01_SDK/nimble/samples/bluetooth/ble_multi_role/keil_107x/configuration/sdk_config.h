...
#define configTOTAL_HEAP_SIZE                               9200
...
#define CONFIG_BLE_HOST_THREAD_STACK_SIZE                   500

// <o> OS BLE Host Thread Priority
#define CONFIG_BLE_HOST_THREAD_PRIO                         4
...
#define CONFIG_BT_MAX_NUM_OF_CENTRAL                        3
...
#define MYNEWT_VAL_BLE_TRANSPORT_ACL_SIZE                   65
...
#define CONFIG_BLE_CONTROLLER_RF_TX_BUF_NUM                 8

// <o> BLE Controller Packet Encrypt Time (unit:us)
#define CONFIG_BLE_CONTROLLER_LL_ENC_TIME                   200

// <o> BLE Controller More Data Number
#define CONFIG_BLE_CONTROLLER_MORE_DATA_NUM                 4
