...
peer_free_mem(void)
{
    ...
    vPortFree(peer_svc_mem);
    peer_svc_mem = NULL;

    vPortFree(peer_chr_mem);
    peer_chr_mem = NULL;

    vPortFree(peer_dsc_mem);
    peer_dsc_mem = NULL;
}
