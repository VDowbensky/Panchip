...
void hid_mouse_init(void)
{
    ...
    usbd_add_interface(0, usbd_hid_init_intf(0, &intf0, hid_mouse_report_desc, HID_MOUSE_REPORT_DESC_SIZE));
...
void hid_mouse_test(void)
{
    ...
    while (counter < 1000) {
        ...
        usbd_ep_start_write(0, HID_INT_EP, (uint8_t *)&mouse_cfg, 4);
