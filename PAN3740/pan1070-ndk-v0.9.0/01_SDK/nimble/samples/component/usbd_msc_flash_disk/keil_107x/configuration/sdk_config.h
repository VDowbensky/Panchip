...
// <q> Use External SPI Flash for USB Storage
// <i> Enable this config to use external SPI Flash as USB MSC and FatFs disk
// <i> Disable this config to use part of internal SoC Flash as that disk.
...
// <i> Note that partition size should be multiple of 4KB!
#define CONFIG_FLASH_PARTITION_USER_CUSTOM_SIZE_KB          272
