...
/**@brief app fifo state code define */
enum{
	APP_FIFO_OK,
	APP_FIFO_NULL,
	APP_FIFO_INVALID_LEN,
	APP_FIFO_NO_MEM,
	APP_FIFO_NOT_FOUND,
	APP_FIFO_INVALID_PARAM,
};
 ...
 *
 * @retval     APP_FIFO_OK              If initialization was successful.
 * @retval     APP_FIFO_NULL            If a NULL pointer is provided as buffer.
 * @retval     APP_FIFO_INVALID_LEN 	  If size of buffer provided is not a power of two.
 */
 ...
 *
 * @retval     APP_FIFO_OK              If an element has been successfully added to the FIFO.
 * @retval     APP_FIFO_NO_MEM          If the FIFO is full.
 */
 ...
 *
 * @retval     APP_FIFO_OK              If an element was returned.
 * @retval     APP_FIFO_NOT_FOUND       If there are no more elements in the queue.
 */
 ...
 *
 * @retval     APP_FIFO_OK              If an element was returned.
 * @retval     APP_FIFO_NOT_FOUND       If there are no more elements in the queue, or the index was
 *                                      too large.
 */
 ...
 * @param[in]  p_fifo   Pointer to the FIFO.
 *
 * @retval     APP_FIFO_OK              If the FIFO was flushed successfully.
 */
 ...
 *
 * @retval     APP_FIFO_OK          If the procedure is successful. The actual number of bytes read might
 ...
 *                                  successful.
 * @retval     APP_FIFO_NULL        If a NULL parameter was passed for a parameter that must not
 *                                  be NULL.
 * @retval     APP_FIFO_NOT_FOUND   If the FIFO is empty.
 */
 ...
 *
 * @retval     APP_FIFO_OK       If the procedure is successful. The actual number of bytes written might
