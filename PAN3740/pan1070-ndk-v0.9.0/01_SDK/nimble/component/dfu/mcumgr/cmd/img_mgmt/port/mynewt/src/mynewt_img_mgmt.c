...
{
    /* Panchip: directly return to support panchip separate OTA flow */
...
{
	img_mgmt_impl_post_handler();
}

img_mgmt_dfu_callbacks_t img_mgmt_dfu_funcs = {
...
img_mgmt_module_init(void)
{
	...
	flash_area_arase_image_swap();

    img_mgmt_register_group();
    
#if FLASH_TIMING_OPTIMIZE_EN
    img_mgmt_register_callbacks(&img_mgmt_dfu_funcs);
#endif
}
