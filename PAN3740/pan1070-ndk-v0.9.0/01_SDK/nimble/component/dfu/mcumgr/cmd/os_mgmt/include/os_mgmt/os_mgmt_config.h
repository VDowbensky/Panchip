...
#define OS_MGMT_RESET_MS    1000 //MYNEWT_VAL(OS_MGMT_RESET_MS)
#define OS_MGMT_TASKSTAT    0//MYNEWT_VAL(OS_MGMT_TASKSTAT)
#define OS_MGMT_ECHO        0//MYNEWT_VAL(OS_MGMT_ECHO)
