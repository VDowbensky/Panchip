...
static uint8_t user_selected_addr_type = 0;

void ble_hs_id_set_used_addr_type(uint8_t addr_type)
{
	user_selected_addr_type = addr_type;
}

uint8_t ble_hs_id_get_used_addr_type(void)
{
	return user_selected_addr_type;
}
#endif
