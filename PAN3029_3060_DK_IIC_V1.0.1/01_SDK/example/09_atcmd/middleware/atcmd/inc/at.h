...
#define AT_CMD_NAME_LEN                256
#define AT_END_MARK_LEN                4

#define AT_OUT_BUF_SIZE                1024
...
#define _AT_CMD_CONCAT(a, b) a##b
#define AT_CMD_CONCAT(a, b) _AT_CMD_CONCAT(a, b)

#define AT_CMD_EXPORT(_name_, _args_expr_, _test_, _query_, _setup_, _exec_)   \
    RT_USED static const struct at_cmd AT_CMD_CONCAT(__at_cmd_##_test_##_query_##_setup_##_exec_, __LINE__) RT_SECTION("RtAtCmdTab") = \
    {                                                                          \
        _name_,                                                                \
        _args_expr_,                                                           \
        _test_,                                                                \
