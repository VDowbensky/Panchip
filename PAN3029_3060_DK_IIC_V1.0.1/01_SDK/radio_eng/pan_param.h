...
/**
* @brief PAN3029/3060 Recommended Default Register Configuration
* @note This configuration parameter is used to initialize the RF transceiver register values ​​after chip power-up.
*/
...
* @note This parameter table is required when setting different frequencies.
* Different frequencies correspond to different VCO parameters, frequency factor, and LO parameters.
* @note This table supports the following frequency ranges:
* Low frequency band:
* - 138.33MHz to 180.00MHz
* - 207.00MHz to 270.00MHz
* - 282.50MHz to 360.00MHz
* - 408.00MHz to 540.00MHz 
* High frequency band: 
...
{ 
  ...
  {168000000, 180000000, 0x7A, 0x0C, 0xC0}, //!< 152.3M 166.4M 180.5M {207500000, 215000000, 0x2A, 0x08, 0xB0}, //!< 197.4M 210.3M 223.3M 
...
/**
* @brief VCO Divider Table
* @note This table is used to store the VCO's divider coefficients.
*/
...
/**
* @brief PAN3029/3060 Low-Band AGC Configuration Parameters
* @note This configuration parameter is used to set the values ​​of the low-band AGC (Automatic Gain Control) related registers.
* @note This parameter supports frequency bands: 138.33MHz to 282.5MHz, 405.00MHz to 565.00MHz
*/
...
* @note This configuration parameter is used to set the value of the low frequency band AGC (automatic gain control) related registers
* @note This parameter supports the frequency band: 810.00MHz ~ 1080.00MHz
*/
...
/**
* @brief This table is used to convert the signal-to-noise ratio (SNR) to a linear value.
* @note The SNR range is -10 to 20dB, and the corresponding linear value range is 10 to 10240.
* @note In order to reduce the computational burden of the MCU, a logarithmic table is used for conversion.
*/
