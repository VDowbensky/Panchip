...
void SPI_Init(SPI_TypeDef *SPIx, SPI_InitTypeDef *SPI_InitStruct)
{
    ...
    REGBITS_MODIFY(SPIx->CR1, SPIx_CR1_MODE_Msk | SPIx_CR1_WIDTH_Msk | SPIx_CR1_SSM_Msk | SPIx_CR1_SMP_Msk | SPIx_CR1_LSBF_Msk | SPIx_CR1_BR_Msk | SPIx_CR1_MSTR_Msk | SPIx_CR1_CPOL_Msk | SPIx_CR1_CPHA_Msk,
