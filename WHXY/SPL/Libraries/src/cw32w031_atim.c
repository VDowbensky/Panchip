...
void ATIM_Init(ATIM_InitTypeDef *ATIM_InitStruct)
{
    ...
    REGBITS_MODIFY(CW_ATIM->CR, ATIM_CR_DIR_Msk | ATIM_CR_ONESHOT_Msk | ATIM_CR_PRS_Msk | ATIM_CR_MODE_Msk | ATIM_CR_BUFPEN_Msk | ATIM_CR_CT_Msk,
