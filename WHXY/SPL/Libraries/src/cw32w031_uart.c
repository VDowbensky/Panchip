...
void USART_Init(UART_TypeDef *USARTx, USART_InitTypeDef *USART_InitStruct)
{
    ...
    /* UARTx_CR1 */
    REGBITS_MODIFY(USARTx->CR1, UARTx_CR1_OVER_Msk | UARTx_CR1_START_Msk | UARTx_CR1_STOP_Msk | UARTx_CR1_PARITY_Msk | UARTx_CR1_RXEN_Msk | UARTx_CR1_TXEN_Msk,
    ...
    /* UARTx_CR2 */
    REGBITS_MODIFY(USARTx->CR2, UARTx_CR2_SOURCE_Msk | UARTx_CR2_RTSEN_Msk | UARTx_CR2_CTSEN_Msk,
