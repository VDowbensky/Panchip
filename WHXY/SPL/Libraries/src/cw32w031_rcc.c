...
void RCC_DeInit(void)
{
    ...
    CW_SYSCTRL->CR1 = (((CW_SYSCTRL->CR1 & (~SYSCTRL_BYPASS_MASK)) | SYSCTRL_BYPASS | RCC_SYSCTRL_HSIEN) & (~RCC_SYSCTRL_CLKCCS) & (~RCC_SYSCTRL_HSECCS) & (~RCC_SYSCTRL_LSECCS) & (~RCC_SYSCTRL_LSELOCKEN) & (~RCC_SYSCTRL_LSIEN) & (~RCC_SYSCTRL_HSEEN));

    /* SWDIO Enable,LOCKUP/WAKEUPCLK Disable*/
    CW_SYSCTRL->CR2 = (((((CW_SYSCTRL->CR2 & (~SYSCTRL_BYPASS_MASK)) | SYSCTRL_BYPASS) & (~RCC_SYSCTRL_SWDIOEN)) & (~RCC_SYSCTRL_LOCKUPEN)) & (~RCC_SYSCTRL_WAKEUPCLKEN));
