...
/* USER CODE BEGIN EV */
/* USER CODE END EV */
extern void BTIM1_IRQHandleCallback(void);
extern void BTIM2_IRQHandleCallback(void);
extern void BTIM3_IRQHandleCallback(void);
