...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
extern uint8_t TxCounter,RxCounter;
extern uint8_t TxBuffer2[],RxBuffer2[];
/* USER CODE END PV */
...
/******************************************************************************/
/* CW32w031 Peripheral Interrupt Handlers                                        */
...
/**
 * @brief This funcation handles GPIOC/GPIOD
 */
...
/**
 * @brief This funcation handles GPIOE/GPIOF
 */
...
/**
 * @brief This funcation handles BTIM2/LPTIM
 */
void BTIM2_LPTIM_IRQHandler(void)
{
    /* USER CODE BEGIN */
...
void UART2_IRQHandler(void)
{
    ...
    if(USART_GetITStatus(CW_UART2, USART_IT_RC) != RESET)
    {
        ...
        if((USART_ReceiveData(CW_UART2) & 0x100) == RESET)
        {
            RxBuffer2[RxCounter] = USART_ReceiveData(CW_UART2);
            USART_SendData(CW_UART2, TxBuffer2[TxCounter++]);
        }
    }
    /* USER CODE END */
}
