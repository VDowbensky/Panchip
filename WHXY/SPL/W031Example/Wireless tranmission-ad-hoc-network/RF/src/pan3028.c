...
uint8_t reg_agc_value[98] = {0x90,0xff,0x64,0x24,0x00,0x03,0x24,0x24,0x00,0x03,0x24,0x24,0x00,0x03,0x24,0x24,\
	...
	uint8_t rf_rxbusy = FALSE;
uint8_t RadioRxPayload[255];
uint8_t RadioRxPayloadLen=0;

uint8_t rf_txbusy = FALSE;
uint8_t plhd_buf[16];
/**
...
void PAN3028_irq_handler(void)
{
	...
	}else if(irq & REG_IRQ_RX_DONE)
	{
		...
		rf_rxbusy = FALSE;
		RadioRxPayloadLen = PAN3028_recv_packet(RadioRxPayload);
		rf_rx_done_event( RadioRxPayload, RadioRxPayloadLen, rssi, snr );
