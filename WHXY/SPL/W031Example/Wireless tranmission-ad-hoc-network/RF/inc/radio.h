...
#define	GPIO_PIN_CAD			GPIO_PIN_7
#define	GPIO_PORT_CAD			CW_GPIOB

#define  CHECK_CAD()   			GPIO_ReadPin(GPIO_PORT_CAD, GPIO_PIN_CAD)
#define  SET_TIMER_MS(time)		GTIM1_MS(time)	

#define MAC_EVT_TX_CAD_NONE			0x00
#define MAC_EVT_TX_CAD_TIMEOUT		0x01
#define MAC_EVT_TX_CAD_ACTIVE		0x02
#define RADIO_FLAG_CAD          6
struct RxDoneMsg
{
	uint8_t *Payload;
	uint8_t *PlhdPayload;
